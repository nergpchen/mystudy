...
/**
 * ApplicationContext:为应用程序提供配置信息：
 * 包括：
 * 1:ListableBeanFactory:Bean factory方法
 * 2:ResourceLoader:可以加载资源文件
 * 3:ApplicationEventPublisher:可以提供监听事件功能
 * 4:MessageSource:支持国际化信息
 * 5：
