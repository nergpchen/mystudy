package org.babyfishdemo.om4jpa.instrument.m2s;
...
import org.babyfishdemo.om4jpa.instrument.m2s.Company;
import org.babyfishdemo.om4jpa.instrument.m2s.Investor;
...
public class InstrumentTest {
    ...
    public void testCompanyObjectModelMetadata() {
        ...
        Assert.assertSame(AssociatedEndpointType.MAP, investorsProperty.getAssociatedEndpointType());
        Assert.assertSame(Map.class, investorsProperty.getStandardReturnClass());
        Assert.assertSame(String.class, investorsProperty.getKeyClass());
