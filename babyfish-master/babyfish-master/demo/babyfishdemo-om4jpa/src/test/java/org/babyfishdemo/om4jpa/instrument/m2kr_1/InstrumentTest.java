package org.babyfishdemo.om4jpa.instrument.m2kr_1;
...
import org.babyfishdemo.om4jpa.instrument.m2kr_1.Department;
import org.babyfishdemo.om4jpa.instrument.m2kr_1.Employee;
...
public class InstrumentTest {
    ...
    public void testDepartmentObjectModelMetadata() {
        ...
        Assert.assertSame(String.class, employeesProperty.getKeyClass());
        Assert.assertSame(String.class, employeesProperty.getKeyClass());
    ...
    public void testEmployeeObjectModelMetadata() {
        ...
        Assert.assertSame(String.class, departmentReferenceProperty.getKeyClass());
