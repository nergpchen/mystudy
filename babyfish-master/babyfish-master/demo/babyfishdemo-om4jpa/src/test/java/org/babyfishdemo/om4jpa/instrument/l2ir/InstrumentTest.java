...
import org.babyfishdemo.om4jpa.instrument.l2ir.Department;
import org.babyfishdemo.om4jpa.instrument.l2ir.Employee;
...
public class InstrumentTest {
    ...
    public void testDepartmentObjectModelMetadata() {
        ...
        Assert.assertSame(AssociatedEndpointType.LIST, employeesProperty.getAssociatedEndpointType());
        Assert.assertSame(List.class, employeesProperty.getStandardReturnClass());
    ...
    public void testEmployeeObjectModelMetadata() {
        ...
        /*
         * The ObjectModel property "departmentReference" is IndexedReferance
         * and its index is mapped to the JPA property "index"
         */
        Assert.assertEquals(
                "departmentReference",
                this.employeeOMM.getDeclaredIndexMappingSources().get("index").getName()
        );
        ...
        Assert.assertSame(AssociatedEndpointType.INDEXED_REFERENCE, departmentReferenceProperty.getAssociatedEndpointType());
        Assert.assertSame(IndexedReference.class, departmentReferenceProperty.getStandardReturnClass());
