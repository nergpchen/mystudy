...
import org.babyfishdemo.om4jpa.instrument.s2s.Company;
import org.babyfishdemo.om4jpa.instrument.s2s.Investor;
...
public class InstrumentTest {
    ...
    public void testCompanyObjectModelMetadata() {
        ...
        Assert.assertSame(AssociatedEndpointType.SET, investorsProperty.getAssociatedEndpointType());
        Assert.assertSame(Set.class, investorsProperty.getStandardReturnClass());
