 ...
 * @Entity
 * @Table(name = "m2kr_2_EMPLOYEE")
 * @SequenceGenerator(
 *     name = "employeeSequence", 
 *     sequenceName = "m2kr_2_EMPLOYEE_ID_SEQ", 
 *     initialValue = 1, 
 *     allocationSize = 1
 * )
 ...
 *     @Embedded
 *     public Key getKey() {
 *         return (Key)this.{om}.getDepartmentReference().getKey();
 *     }
 * 
 *     public void setKey(Key paramKey) {
 *         this.{om}.getKeyReference().setKey(paramKey); 
 *     }
 *     
 ...
 *         @KeyMapping("key")
 *         KeyedReference<Key, Department> getDepartmentReference();
 *     }
 * }
 */
/**
