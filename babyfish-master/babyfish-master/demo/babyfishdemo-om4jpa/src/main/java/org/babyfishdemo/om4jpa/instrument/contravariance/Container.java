 ...
 *     @OrderColumn(name = "INDEX_IN_CONTAINER")
 *     public List<Component> getComponents() {
 *         return {om}.getComponents();
 *     }
 * 
 *     public void setComponents(List<Component> paramList) {
 *         List localList = {om}.getComponents(); localList.clear(); if (paramList != null) localList.addAll(paramList);
 *     }
 * 
 *     @StaticMethodToGetObjectModel
 *     static {OM} {om}(Container paramContainer) {
 *         return return paramContainer.{om};
 *     }
 * 
