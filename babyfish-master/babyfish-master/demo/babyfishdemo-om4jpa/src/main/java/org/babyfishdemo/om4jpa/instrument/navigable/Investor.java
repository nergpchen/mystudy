 ...
 * @Entity
 * @Table(name="m2s_INVESTOR")
 * @SequenceGenerator(
 *     name="investorSequence", 
 *     sequenceName="m2s_INVESTOR_ID_SEQ", 
 *     initialValue=1, 
 *     allocationSize=1
 * )
 ...
 *         Set localSet = {om}.getCompanys(); localSet.clear(); if (paramSet != null) localSet.addAll(paramSet);
 *     }
 * 
 ...
 *         NavigableSet<Company> getCompanys(); // Note: NavigableSet, not Set.
 *     }
 * }
 */
/**
