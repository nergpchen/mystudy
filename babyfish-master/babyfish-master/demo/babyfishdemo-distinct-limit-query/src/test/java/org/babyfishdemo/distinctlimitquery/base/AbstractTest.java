...
import org.babyfishdemo.distinctlimitquery.jdbc.SqlAwareOracleDriver;
import org.babyfishdemo.distinctlimitquery.jdbc.SqlRecorder;
    ...
    private static String processSql(String sql) {
        ...
        if (selectIndex != -1) {
            ...
            if (columns.indexOf(',') == -1) {
                ...
                columns = Joins.join(colNameList);
            }
            sql = 
