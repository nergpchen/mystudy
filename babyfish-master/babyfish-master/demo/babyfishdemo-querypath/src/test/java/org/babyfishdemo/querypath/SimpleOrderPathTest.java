...
public class SimpleOrderPathTest extends AbstractTest {
    ...
    public void testFetchAndOrderChildren() {
        ...
        /*
         * Notes: this test case required ObjectModel4JPA,
         * so all the entity classes is marked by @JPAObjectModelInstrument and 
         * the byte-code instrument task are declared in pom.xml.
         * 
         * ObjectModel4JPA has replaced the ORM collection implementation of hibernate.
         * The implementation of collections for @OneToMany/@ManyToMany associations are:
         * 
         * +-----------------+----------------------+------------------------------------------------------------------+
         * | Classic hbm tag | Interface in Entity  | Actual collection Implementation classes                         |
         * +-----------------+----------------------+------------------------------------------------------------------+
         * |                 |                      | +-org.babyfish.hibernate.association.EntityCollection            |  
         * |                 |                      | |                                                                |
         * |                 |                      | | {Wrapper of}                                                   |
         * |                 |                      | |                                                                |
         * |                 |                      | +-----org.babyfish.collection.MALinkedHashSet                    |
         * |                 |                      | |                                                                |
         * | <bag/>          | java.util.Collection | | {or}                                                           |
         * |                 |                      | |                                                                |
         * |                 |                      | \---+-org.babyfish.hibernate.collection.PersistentMAOrderedSet   |
         * |                 |                      |     |                                                            |
         * |                 |                      |     | {Wrapper of}                                               |
         * |                 |                      |     |                                                            |
         * |                 |                      |     \-----org.babyfish.collection.MALinkedHashSet                |
         * +-----------------+----------------------+------------------------------------------------------------------+
         * |                 |                      | +-org.babyfish.hibernate.association.EntityOrderedSet            |  
         * |                 |                      | |                                                                |
         * |                 |                      | | {Wrapper of}                                                   |
         * |                 |                      | |                                                                |
         * |                 |                      | +-----org.babyfish.collection.MALinkedHashSet                    |
         ...
         * |                 |                      |     \-----org.babyfish.collection.MALinkedHashSet                |
         * | <set/>          | java.util.Set        +------------------------------------------------------------------+
         * |                 |                      | +-org.babyfish.hibernate.association.EntityNavigableSet          |  
         * |                 |                      | |                                                                |
         * |                 |                      | | {Wrapper of}                                                   |
         * |                 |                      | |                                                                |
         * |                 |                      | +-----org.babyfish.collection.MATreeSet                          |
         * |                 |                      | |                                                                |
         * |                 |                      | | {or}                                                           |
         * |                 |                      | |                                                                |
         * |                 |                      | \---+-org.babyfish.hibernate.collection.PersistentMANavigableSet |
         * |                 |                      |     |                                                            |
         * |                 |                      |     | {Wrapper of}                                               |
         * |                 |                      |     |                                                            |
         * |                 |                      |     \-----org.babyfish.collection.MATreeSet                      |
         * +-----------------+----------------------+------------------------------------------------------------------+
         * |                 |                      | +-org.babyfish.hibernate.association.EntityList                  |  
         * |                 |                      | |                                                                |
         * |                 |                      | | {Wrapper of}                                                   |
         * |                 |                      | |                                                                |
         * |                 |                      | +-----org.babyfish.collection.MAArrayList                        |
         * |                 |                      | |                                                                |
         * | <list/>         | java.util.List       | | {or}                                                           |
         * |                 |                      | |                                                                |
         * |                 |                      | \---+-org.babyfish.hibernate.collection.PersistentMAList         |
         * |                 |                      |     |                                                            |
         * |                 |                      |     | {Wrapper of}                                               |
         * |                 |                      |     |                                                            |
         * |                 |                      |     \-----org.babyfish.collection.MAArrayList                    |
         * +-----------------+----------------------+------------------------------------------------------------------+
         * |                 |                      | +-org.babyfish.hibernate.association.EntityOrderedMap            |  
         * |                 |                      | |                                                                |
         * |                 |                      | | {Wrapper of}                                                   |
         * |                 |                      | |                                                                |
         * |                 |                      | +-----org.babyfish.collection.MALinkedHashMap                    |
         * |                 |                      | |                                                                |
         * |                 |                      | | {or}                                                           |
         * |                 |                      | |                                                                |
         * |                 |                      | \---+-org.babyfish.hibernate.collection.PersistentMAOrderedMap   |
         * |                 |                      |     |                                                            |
         * |                 |                      |     | {Wrapper of}                                               |
         * |                 |                      |     |                                                            |
         * |                 |                      |     \-----org.babyfish.collection.MALinkedHashMap                |
         * | <map/>          | java.util.Map        +------------------------------------------------------------------+
         * |                 |                      | +-org.babyfish.hibernate.association.EntityNavigableMap          |  
         * |                 |                      | |                                                                |
         * |                 |                      | | {Wrapper of}                                                   |
         * |                 |                      | |                                                                |
         * |                 |                      | +-----org.babyfish.collection.MATreeMap                          |
         * |                 |                      | |                                                                |
         * |                 |                      | | {or}                                                           |
         * |                 |                      | |                                                                |
         * |                 |                      | \---+-org.babyfish.hibernate.collection.PersistentMANavigableMap |
         * |                 |                      |     |                                                            |
         * |                 |                      |     | {Wrapper of}                                               |
         * |                 |                      |     |                                                            |
         * |                 |                      |     \-----org.babyfish.collection.MATreeMap                      |
         * +-----------------+----------------------+------------------------------------------------------------------+
         * 
         * In this demo project, the collection association "Department.employees" is implemented by
         * 
         *     +-org.babyfish.hibernate.association.EntityCollection
         *     |
         *     | {Wrapper of}
         ...
         *         \-----org.babyfish.collection.MALinkedHashSet
         *         
         * These collections implements "org.babyfish.collection.XOrderedSet" that has similar behavior to 
         * "java.util.LinkedHashSet" so that they can manage the elements with predictable iteration order.
         * That's why we can see "Department.employees" can keep the element order specified by SimpleOrderPath
         * in this test method.
         */
    }
