...
public class OrderItem {
    ...
    private Set<PreferentialAction> preferentialActions;
    ...
    public Set<PreferentialAction> getPreferentialActions() {
        return preferentialActions;
    }

    public void setPreferentialActions(Set<PreferentialAction> preferentialActions) {
        this.preferentialActions = preferentialActions;
    }
