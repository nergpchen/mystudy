...
public class FrozenComparatorTest {
    ...
    /*
     * "Department.getEmployees()" uses the "firstName" and "lastName" to compare two Employee objects, 
    ...
    public void test() {
        ...
        
        {
	        ...
	        assertDepartment(department, employee2, employee3, employee1); // Changed automatically
        ...
        
        {
	        ...
	        assertDepartment(department, employee3, employee1, employee2); // Changed automatically
	        Assert.assertSame(department, employee1.getDepartment());
	        Assert.assertSame(department, employee2.getDepartment());
	        Assert.assertSame(department, employee3.getDepartment());
        }
        ...
        
        {
	         ...
	         * (1) employee1 is removed from the navigable map automatically
