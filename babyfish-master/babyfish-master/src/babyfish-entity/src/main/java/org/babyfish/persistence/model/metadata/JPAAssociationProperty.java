 ...
 * @author Tao Chen
 */
public interface JPAAssociationProperty 
extends AssociationProperty, JPAProperty {
    ...
    @Override
    JPAObjectModelMetadata getKeyObjectModelMetadata();
    
    PropertyInfo getOwnerIndexProperty();

    PropertyInfo getOwnerKeyProperty();

    boolean isInverse();
    
    LazyBehavior getLazyBehavior();
}
