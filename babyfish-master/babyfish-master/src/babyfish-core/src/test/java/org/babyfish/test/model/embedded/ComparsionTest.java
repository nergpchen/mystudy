...
import org.babyfish.test.model.embedded.entities.Address;
import org.babyfish.test.model.embedded.entities.ContactInfo;
import org.babyfish.test.model.embedded.entities.Customer;
...
public class ComparsionTest {
    ...
    static {
        EQUALITY_COMPARATOR = Metadatas.of(Customer.class).getOwnerEqualityComparator("contactInfo");
        COMPARATOR = Metadatas.of(Customer.class).getOwnerComparator("contactInfo");
    }
}
