...
public class MACollectionsTest {
    ...
    public void testLockedEntry() {
        ...
        Map<String, String> m;
        Map.Entry<String, String> e;
        Func<Iterator<Entry<String, String>>, Entry<String, String>> lockingAction = 
            new Func<Iterator<Entry<String, String>>, Entry<String, String>>() {
                @Override
                public Entry<String, String> run(Iterator<Entry<String, String>> iterator) {
        ...
        e = MACollections.locking(m.entrySet().iterator(), LockMode.READ, lockingAction);
    ...
    public void testReturnableLocking() {
        ...
        String value = MACollections.locking(
                iterator, 
                LockMode.READ, 
                new Func<Iterator<String>, String>() {
                    @Override
                    public String run(Iterator<String> iterator) {
                        StringBuilder builder = new StringBuilder();
    ...
    public void testLocking() {
        ...
        MACollections.locking(
                iterator, 
                LockMode.WRITE, 
                new Action<Iterator<String>>() {
                    @Override
                    public void run(Iterator<String> iterator) {
                        while (iterator.hasNext()) {
                            builder
                            .append('-')
                            .append(iterator.next());
    ...
    private static void assertLockedType(Object o, final Class<?> expectedType) {
        ...
        if (o instanceof Map<?, ?>) {
            MACollections.locking(
                    (Map<Object, Object>)o, 
                    LockMode.READ, 
                    new Action<Map<Object, Object>>() {
                        @Override
                        public void run(Map<Object, Object> lockingObj) {
            ...
            MACollections.locking(
                    (Map<Object, Object>)o, 
                    LockMode.READ, 
                    new Func<Map<Object, Object>, Object>() {
                        @Override
                        public Object run(Map<Object, Object> lockingObj) {
                            assertLockingType(lockingObj, expectedType);
                            matchRef.set(matchRef.get() + 1);
                            return null;
                        }
            ...
            MACollections.locking(
                    (Collection<Object>)o, 
                    LockMode.READ, 
                    new Action<Collection<Object>>() {
                        @Override
                        public void run(Collection<Object> lockingObj) {
                            assertLockingType(lockingObj, expectedType);
                            matchRef.set(matchRef.get() + 1);
                        }
                    });
            MACollections.locking(
                    (Collection<Object>)o, 
                    LockMode.READ, 
                    new Func<Collection<Object>, Object>() {
                        @Override
                        public Object run(Collection<Object> lockingObj) {
                            assertLockingType(lockingObj, expectedType);
                            matchRef.set(matchRef.get() + 1);
                            return null;
                        }
            ...
            MACollections.locking(
                    (Iterator<Object>)o, 
                    LockMode.READ, 
                    new Action<Iterator<Object>>() {
                        @Override
                        public void run(Iterator<Object> lockingObj) {
                            assertLockingType(lockingObj, expectedType);
                            matchRef.set(matchRef.get() + 1);
                        }
                    });
            MACollections.locking(
                    (Iterator<Object>)o, 
                    LockMode.READ, 
                    new Func<Iterator<Object>, Object>() {
                        @Override
                        public Object run(Iterator<Object> lockingObj) {
                            assertLockingType(lockingObj, expectedType);
                            matchRef.set(matchRef.get() + 1);
                            return null;
                        }
            ...
            MACollections.locking(
                    ...
                    LockMode.READ, 
                    new Action<Entry<Object, Object>>() {
                        @Override
                        public void run(Entry<Object, Object> lockingObj) {
                            assertLockingType(lockingObj, expectedType);
                            matchRef.set(matchRef.get() + 1);
                        }
                    });
            MACollections.locking(
                    (Entry<Object, Object>)o, 
                    LockMode.READ, 
                    new Func<Entry<Object, Object>, Object>() {
                        @Override
                        public Object run(Entry<Object, Object> lockingObj) {
                            assertLockingType(lockingObj, expectedType);
                            matchRef.set(matchRef.get() + 1);
                            return null;
                        }
