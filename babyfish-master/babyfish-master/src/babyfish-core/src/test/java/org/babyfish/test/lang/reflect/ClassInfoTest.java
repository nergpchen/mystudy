 ...
 * for more details.
 */
package org.babyfish.test.lang.reflect;
...
public class ClassInfoTest {
    ...
    public void testNestedClass7WithoutParameter() {
        ...
        MethodInfo methodF = inner.getSuperClass().getSuperClass().getSuperClass().getDeclaredErasedMethod(
                "f", Object[][].class);
        Assert.assertEquals(
                "T[] org.babyfish.test.lang.reflect.ClassInfoTest$Outer_7<T>.f(T[][])", 
    ...
    public void testNestedClass7WithParameter() {
        ...
        Assert.assertEquals(
                "T[] " +
                "org.babyfish.test.lang.reflect.ClassInfoTest$Outer_7<T>" +
                ".f(T[][])", 
                methodF.toGenericString());
        Assert.assertEquals(
                "java.lang.String[][][][] " +
                "org.babyfish.test.lang.reflect.ClassInfoTest.Outer_7<java.lang.String[][][]>" +
                ".f(java.lang.String[][][][][])", 
                methodF.toResolvedGenericString());
    }
    ...
    public void testXAndItsNestedClassWithoutParameters() {
        ...
        Assert.assertEquals(
                "java.util.Map " +
                "org.babyfish.test.lang.reflect.ClassInfoTest$X$_A$_D$_E$__C" +
                ".method_1(java.lang.Object[])",
                method_1.toString());
        Assert.assertEquals(
                "java.util.Map<T6[], T6[][]> " +
                "org.babyfish.test.lang.reflect.ClassInfoTest$X$_A$_D$_E<T6>.__C<T9>" +
                ".method_1(T9[])",
                method_1.toGenericString());
        Assert.assertEquals(
                "java.util.Map " +
                "org.babyfish.test.lang.reflect.ClassInfoTest$X$_A$_D._E<java.lang.Object[]>.__C<java.lang.Object[]>" +
                ".method_1(java.lang.Object[][])",
                method_1.toResolvedString());
        Assert.assertEquals(
                "java.util.Map<T10[][], T10[][][]> " +
                "org.babyfish.test.lang.reflect.ClassInfoTest$X$_A$_D._E<T10[]>.__C<T9[]>" +
                ".method_1(T9[][])",
                method_1.toResolvedGenericString());

        Assert.assertEquals(
                "java.util.Map " +
                "org.babyfish.test.lang.reflect.ClassInfoTest$X$A_$B_" +
                ".method_2(java.util.Map[])",
                method_2.toString());
        Assert.assertEquals(
                "java.util.Map<T50, java.util.Map<T50[], java.util.Collection<? extends T51>>> " +
                "org.babyfish.test.lang.reflect.ClassInfoTest$X<T1>.A_<T50>.B_<T51>" +
                ".method_2(java.util.Map<? super T51, java.util.Collection<? super T50>[]>[])",
                method_2.toGenericString());
        Assert.assertEquals(
                "java.util.Map " +
                "org.babyfish.test.lang.reflect.ClassInfoTest.X<java.lang.Object[]>.A_<java.lang.Object[]>.B_<java.lang.String[]>" +
                ".method_2(java.util.Map[])",
                method_2.toResolvedString());
        Assert.assertEquals(
                "java.util.Map<T11[], java.util.Map<T11[][], java.util.Collection<? extends java.lang.String[]>>> " +
                "org.babyfish.test.lang.reflect.ClassInfoTest.X<T2[]>.A_<T11[]>.B_<java.lang.String[]>" +
                ".method_2(java.util.Map<? super java.lang.String[], java.util.Collection<? super T11[]>[]>[])",
                method_2.toResolvedGenericString());

        Assert.assertEquals(
                "java.util.Map " +
                "org.babyfish.test.lang.reflect.ClassInfoTest$X$A_$B_$C_$D_$E_" +
                ".method_3(java.lang.Object,java.lang.Object[],java.util.List[],java.util.List[])",
                method_3.toString());
        Assert.assertEquals(
                "java.util.Map<T50[], java.util.Map<T51[], T52[][]>[][][]> " +
                "org.babyfish.test.lang.reflect.ClassInfoTest$X<T1>.A_<T50>.B_<T51>.C_<T52>.D_<T53>.E_<T54>" +
                ".method_3(T53, T53[], java.util.List<T53[]>[], java.util.List<? super T54>[])",
                method_3.toGenericString());
        Assert.assertEquals(
                "java.util.Map " +
                "org.babyfish.test.lang.reflect.ClassInfoTest.X<java.lang.Object>.A_<java.lang.Object[][]>.B_<java.lang.Object[]>.C_<java.lang.Object>.D_<java.lang.Object[]>.E_<java.lang.Object[]>" +
                ".method_3(java.lang.Object[], java.lang.Object[][], java.util.List[], java.util.List[])",
                method_3.toResolvedString());
        Assert.assertEquals(
                "java.util.Map<T56[][][], java.util.Map<T53[][], T56[][]>[][][]> " +
                "org.babyfish.test.lang.reflect.ClassInfoTest.X<T1>.A_<T56[][]>.B_<T53[]>.C_<T56>.D_<T56[]>.E_<T50[]>" +
                ".method_3(T56[], T56[][], java.util.List<T56[][]>[], java.util.List<? super T50[]>[])",
                method_3.toResolvedGenericString());

        Assert.assertEquals(
                "java.lang.Object[] " +
                "org.babyfish.test.lang.reflect.ClassInfoTest$X$_A$_B" +
                ".method_4(java.util.Map[])",
                method_4.toString());
        Assert.assertEquals(
                "T3[] " +
                "org.babyfish.test.lang.reflect.ClassInfoTest$X$_A$_B<T3>" +
                ".method_4(java.util.Map<? super T3, ? extends T3>[])",
                method_4.toGenericString());
        Assert.assertEquals(
                "java.lang.Object[][][][][] " +
                "org.babyfish.test.lang.reflect.ClassInfoTest$X$_A._B<java.lang.Object[][][][]>" +
                ".method_4(java.util.Map[])",
                method_4.toResolvedString());
        Assert.assertEquals(
                "T9[][][][][] " +
                "org.babyfish.test.lang.reflect.ClassInfoTest$X$_A._B<T9[][][][]>" +
                ".method_4(java.util.Map<? super T9[][][][], ? extends T9[][][][]>[])",
                method_4.toResolvedGenericString());

        Assert.assertEquals(
                "void " +
                "org.babyfish.test.lang.reflect.ClassInfoTest$X" +
                ".method_5(java.lang.Object)",
                method_5.toString());
        Assert.assertEquals(
                "void " +
                "org.babyfish.test.lang.reflect.ClassInfoTest$X<T1>" +
                ".method_5(T1)",
                method_5.toGenericString());
        Assert.assertEquals(
                "void " +
                "org.babyfish.test.lang.reflect.ClassInfoTest.X<java.lang.Object[][][][][]>" +
                ".method_5(java.lang.Object[][][][][])",
                method_5.toResolvedString());
        Assert.assertEquals(
                "void " +
                "org.babyfish.test.lang.reflect.ClassInfoTest.X<T9[][][][][]>" +
                ".method_5(T9[][][][][])",
