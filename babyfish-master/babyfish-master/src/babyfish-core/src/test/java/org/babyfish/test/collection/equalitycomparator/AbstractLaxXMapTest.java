 ...
 * @author Tao Chen
 */
public abstract class AbstractLaxXMapTest extends AbstractXMapTest {
                    ...
                    new MapElementListener<Element, Element>() {
                        ...
                        public void modifying(MapElementEvent<Element, Element> e) throws Throwable {
                            if (e.getModificationType().contains(PropertyVersion.DETACH)) {
                                AbstractLaxXMapTest.this.eventLog +=
                                    "-DI[" +
    ...
    public void testPut() {
        ...
        if (this.eventLog != null) {
            Assert.assertEquals(
                    ...
                    "-AI[{code:001,name:Jim}]{code:Couple-I,name:Jim2|Kate}" +
                    "-DE[{code:001,name:Jim}]{code:Couple-I,name:Jim|Kate}" +
                    "-AE[{code:001,name:Jim}]{code:Couple-I,name:Jim2|Kate}", 
                    this.eventLog);
            this.resetEventLog();
        }
        Helper.assertElementCodes(this.xmap.keySet(), "001");
        ...
        Helper.assertElementNames(this.xmap.keySet(), "Jim", "Kate");
        ...
        if (this.eventLog != null) {
            Assert.assertEquals(
                    ...
                    "-AI[{code:002,name:Kate}]{code:Couple-I,name:Jim2|Kate2}" +
                    "-DE[{code:002,name:Kate}]{code:Couple-I,name:Jim2|Kate}" +
                    "-AE[{code:002,name:Kate}]{code:Couple-I,name:Jim2|Kate2}", 
                    this.eventLog);
            this.resetEventLog();
        }
        Helper.assertElementCodes(this.xmap.keySet(), "001", "002");
    ...
    public void testPutAllByMapWithDiffComparatorAndWithDuplicatedElementForThisMap() {
        ...
        if (this.eventLog != null) {
            Assert.assertEquals(
                    "-AI[{code:001,name:Jim}]{code:Couple-I,name:Jim.1|Kate.1}" +
                    "-AI[{code:002,name:Kate}]{code:Couple-I,name:Jim.1|Kate.1}" +
                    "-AI[{code:003,name:Smith}]{code:Couple-II,name:Smith.1|Linda.1}" +
                    "-AI[{code:004,name:Linda}]{code:Couple-II,name:Smith.1|Linda.1}" +
                    "-AE[{code:001,name:Jim}]{code:Couple-I,name:Jim.1|Kate.1}" +
                    "-AE[{code:002,name:Kate}]{code:Couple-I,name:Jim.1|Kate.1}" +
                    "-AE[{code:003,name:Smith}]{code:Couple-II,name:Smith.1|Linda.1}" +
                    "-AE[{code:004,name:Linda}]{code:Couple-II,name:Smith.1|Linda.1}",
                    this.eventLog);
            this.resetEventLog();
        }
        ...
        if (this.eventLog != null) {
            Assert.assertEquals(
                    "-DI[{code:001,name:Jim}]{code:Couple-I,name:Jim.1|Kate.1}" +
                    "-AI[{code:001,name:Jim}]{code:Couple-I,name:Jim.1-2|Kate.1-2}" +
                    "-DI[{code:002,name:Kate}]{code:Couple-I,name:Jim.1|Kate.1}" +
                    "-AI[{code:002,name:Kate}]{code:Couple-I,name:Jim.1-2|Kate.1-2}" +
                    "-DI[{code:003,name:Smith}]{code:Couple-II,name:Smith.1|Linda.1}" +
                    "-AI[{code:003,name:Smith}]{code:Couple-II,name:Smith.1-2|Linda.1-2}" +
                    "-DI[{code:004,name:Linda}]{code:Couple-II,name:Smith.1|Linda.1}" +
                    "-AI[{code:004,name:Linda}]{code:Couple-II,name:Smith.1-2|Linda.1-2}" +
                    "-DE[{code:001,name:Jim}]{code:Couple-I,name:Jim.1|Kate.1}" +
                    "-AE[{code:001,name:Jim}]{code:Couple-I,name:Jim.1-2|Kate.1-2}" +
                    "-DE[{code:002,name:Kate}]{code:Couple-I,name:Jim.1|Kate.1}" +
                    "-AE[{code:002,name:Kate}]{code:Couple-I,name:Jim.1-2|Kate.1-2}" +
                    "-DE[{code:003,name:Smith}]{code:Couple-II,name:Smith.1|Linda.1}" +
                    "-AE[{code:003,name:Smith}]{code:Couple-II,name:Smith.1-2|Linda.1-2}" +
                    "-DE[{code:004,name:Linda}]{code:Couple-II,name:Smith.1|Linda.1}" +
                    "-AE[{code:004,name:Linda}]{code:Couple-II,name:Smith.1-2|Linda.1-2}",
                    this.eventLog);
            this.resetEventLog();
        }
        Helper.assertElementCodes(this.xmap.keySet(), "001", "002", "003", "004");
    ...
    private void testPutAllByMapWithoutDuplicatedElementForThisMap(UnifiedComparator<? super Element> keyUnifiedComparator) {
        ...
        if (this.eventLog != null) {
            Assert.assertEquals(
                    "-DI[{code:001,name:Jim}]{code:Couple-I,name:Jim|Kate}" +
                    "-AI[{code:001,name:Jim}]{code:Couple-I,name:Jim2|Kate2}" +
                    ...
                    "-DE[{code:001,name:Jim}]{code:Couple-I,name:Jim|Kate}" +
                    "-AE[{code:001,name:Jim}]{code:Couple-I,name:Jim2|Kate2}" +
        ...
        Helper.assertElementNames(this.xmap.keySet(), "Jim", "Kate", "Smith", "Linda", "Sam", "Lucy");
        ...
        if (this.eventLog != null) {
            Assert.assertEquals(
                    ...
                    "-AI[{code:003,name:Smith}]{code:Couple-II,name:Smith2|Linda2}" +
                    "-DI[{code:004,name:Linda}]{code:Couple-II,name:Smith|Linda}" +
                    "-AI[{code:004,name:Linda}]{code:Couple-II,name:Smith2|Linda2}" +
                    "-DI[{code:005,name:Sam}]{code:Couple-III,name:Sam|Lucy}" +
                    "-AI[{code:005,name:Sam}]{code:Couple-III,name:Sam2|Lucy2}" +
                    "-DI[{code:006,name:Lucy}]{code:Couple-III,name:Sam|Lucy}" +
                    "-AI[{code:006,name:Lucy}]{code:Couple-III,name:Sam2|Lucy2}" +
                    "-DE[{code:003,name:Smith}]{code:Couple-II,name:Smith|Linda}" +
                    "-AE[{code:003,name:Smith}]{code:Couple-II,name:Smith2|Linda2}" +
                    "-DE[{code:004,name:Linda}]{code:Couple-II,name:Smith|Linda}" +
                    "-AE[{code:004,name:Linda}]{code:Couple-II,name:Smith2|Linda2}" +
                    "-DE[{code:005,name:Sam}]{code:Couple-III,name:Sam|Lucy}" +
                    "-AE[{code:005,name:Sam}]{code:Couple-III,name:Sam2|Lucy2}" +
                    "-DE[{code:006,name:Lucy}]{code:Couple-III,name:Sam|Lucy}" +
                    "-AE[{code:006,name:Lucy}]{code:Couple-III,name:Sam2|Lucy2}",
                    this.eventLog);
            this.resetEventLog();
        }
        Helper.assertElementCodes(this.xmap.keySet(), "001", "002", "003", "004", "005", "006");
