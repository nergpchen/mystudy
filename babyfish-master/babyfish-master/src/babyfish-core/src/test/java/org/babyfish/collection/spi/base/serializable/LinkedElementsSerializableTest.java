 ...
 * @author Tao Chen
 */
public class LinkedElementsSerializableTest extends AbstractBaseElementsSerializableTest {

    @Override
    protected BaseElements<String> createBaseElements(UnifiedComparator<String> unifiedComparator) {
        return new LinkedElements<>(ReaderOptimizationType.OPTIMIZE_READING, unifiedComparator);
    }
