...
public class NavigableRangeTest {
    ...
    public void testDescendingRange() {
        NavigableBaseEntries<String, String> baseEntries = 
                new RedBlackTreeEntries<>(ReplacementRule.OLD_REFERENCE_WIN, null, null);
    ...
    public void rangeFormSetWithoutInclusive() {
        ...
        NavigableRange<String> range =
                new NavigableRange<String>(
                        ...
                        .descendingSet()
                        .descendingSet(), 
                        new Func<XNavigableSetView<String>, XNavigableSet<String>>() {
                            @Override
                            public XNavigableSet<String> run(XNavigableSetView<String> x) {
                                return get(x, PARENT_SET);
                            }
                        }
                );
    ...
    public void rangeFormMapWithoutInclusive() {
        ...
        NavigableRange<String> range =
                new NavigableRange<String>(
                        ...
                        .descendingMap()
                        .descendingMap(),
                        new Func<XNavigableMapView<String, ?>, XNavigableMap<String, ?>>() {
                            @Override
                            public XNavigableMap<String, ?> run(XNavigableMapView<String, ?> x) {
                                return get(x, PARENT_MAP);
                            }
                        }
                );
        Assert.assertSame(MACollections.reverseOrder(), range.comparator(false));
