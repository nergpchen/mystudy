...
public class PersonTest {
    ...
    public void testBubbleScalarEvent() {
        ...
        ((ObjectModel)Person.om(person)).addScalarListener(listener);
    ...
    static class ScalarListenerImpl implements ScalarListener {
        ...
        private void append(ScalarEvent e) {
            ...
            .append("");
            if (e.getCause() != null) {
                ScalarEvent rawEvent = (ScalarEvent)e.getCause().getEvent();
                this
                .builder
                .append(", causeScalarPropertyName: '")
                .append(rawEvent.getProperty().getName())
                .append('\'');
            }
            this.builder.append(" }");
        }
