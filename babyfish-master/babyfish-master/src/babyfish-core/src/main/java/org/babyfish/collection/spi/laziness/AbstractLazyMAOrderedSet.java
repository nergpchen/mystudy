 ...
 * @author Tao Chen
 */
public abstract class AbstractLazyMAOrderedSet<E> extends AbstractLazyMASet<E> implements MAOrderedSet<E> {
    
    protected AbstractLazyMAOrderedSet(MAOrderedSet<E> base) {
        super(base);
    }

    protected AbstractLazyMAOrderedSet(
            AbstractLazyMAOrderedSet<E> parent, ViewInfo viewInfo) {
    ...
    protected static class DescendingSetImpl<E> extends AbstractLazyMAOrderedSet<E> implements MAOrderedSetView<E> {

        protected DescendingSetImpl(AbstractLazyMAOrderedSet<E> parent) {
    ...
    protected static abstract class AbstractIteratorImpl<E> extends AbstractLazyMASet.AbstractIteratorImpl<E> {
        ...
        public AbstractIteratorImpl(
                AbstractLazyMAOrderedSet<E> owner, ViewInfo viewInfo) {
    ...
    protected static class DescendingIteratorImpl<E> extends AbstractIteratorImpl<E> {
        ...
        public DescendingIteratorImpl(AbstractLazyMAOrderedSet<E> owner) {
    ...
    protected static abstract class RootData<E> extends AbstractLazyMASet.RootData<E> {
        ...
        private static final long serialVersionUID = -4895308829618620108L;
