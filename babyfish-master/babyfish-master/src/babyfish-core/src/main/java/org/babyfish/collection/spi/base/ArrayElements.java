        ...
        if (o == null) {
            ...
            for (int i = subListHeadHide; i < fenceIndex; i++) {
                ...
                if (unifiedComparator.equals((E)o, ei)) {
                    if (o == null || matcher == null || matcher.match((E)o, ei)) {
                        return i - subListHeadHide;
                    }
                }
            }
        ...
        if (trigger == null || trigger.beginExecute()) {
            try {
                if (this.allSize == subListSize) {
                    ...
                    if (newCapacity != -1) {
                        Object[] newData = new Object[newCapacity];
                        System.arraycopy(this.data, 0, newData, 0, subListHeadHide);
                        System.arraycopy(this.data, subListHeadHide + subListSize, newData, subListHeadHide, subListTailHide);
                        this.data = newData;
                    } else {
                        Object[] data = this.data;
                        System.arraycopy(data, subListHeadHide + subListSize, data, subListHeadHide, subListTailHide);
