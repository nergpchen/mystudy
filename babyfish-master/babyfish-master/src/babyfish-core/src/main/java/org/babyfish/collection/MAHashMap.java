...
public class MAHashMap<K, V> extends AbstractMAMap<K, V> implements Serializable {
    ...
    public MAHashMap(EqualityComparator<? super K> keyEqualityComparator, EqualityComparator<? super V> valueEqualityComparator) {
        super(
                new HashEntries<K, V>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        keyEqualityComparator,
    ...
    public MAHashMap(EqualityComparator<? super K> keyEqualityComparator, Comparator<? super V> valueComparator) {
        super(
                new HashEntries<K, V>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        keyEqualityComparator,
    ...
    public MAHashMap(EqualityComparator<? super K> keyEqualityComparator, UnifiedComparator<? super V> valueUnifiedComparator) {
        super(
                new HashEntries<K, V>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        keyEqualityComparator,
    ...
    public MAHashMap(ReplacementRule keyReplacementRule, EqualityComparator<? super K> keyEqualityComparator) {
        super(
                new HashEntries<K, V>(
                        keyReplacementRule,
                        keyEqualityComparator,
    ...
    public MAHashMap(ReplacementRule keyReplacementRule, Map<? extends K, ? extends V> m) {
        super(
                new HashEntries<K, V>(
                        keyReplacementRule,
                        null,
    ...
    public MAHashMap(EqualityComparator<? super K> keyEqualityComparator, Map<? extends K, ? extends V> m) {
        super(
                new HashEntries<K, V>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        keyEqualityComparator,
