...
public class HashSet<E> extends AbstractXSet<E> implements Serializable {
    ...
    private static final long serialVersionUID = 2163821556808223876L;
    ...
    public HashSet(ReplacementRule replacementRule) {
        super(
                new HashEntries.TransientValue<E, Object>(
                        replacementRule,
                        null,
    ...
    public HashSet(EqualityComparator<? super E> equalityComparator) {
        super(
                new HashEntries.TransientValue<E, Object>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        equalityComparator,
    ...
    public HashSet(ReplacementRule replacementRule, EqualityComparator<? super E> equalityComparator) {
        super(
                new HashEntries.TransientValue<E, Object>(
                        replacementRule,
                        equalityComparator,
    ...
    public HashSet(ReplacementRule replacementRule, int initCapacity) {
        super(
                new HashEntries.TransientValue<E, Object>(
                        replacementRule,
                        null,
    ...
    public HashSet(EqualityComparator<? super E> equalityComparator, int initCapacity) {
        super(
                new HashEntries.TransientValue<E, Object>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        equalityComparator,
    ...
    public HashSet(ReplacementRule replacementRule, Collection<? extends E> c) {
        super(
                new HashEntries.TransientValue<E, Object>(
                        replacementRule,
                        null,
    ...
    public HashSet(EqualityComparator<? super E> equalityComparator, Collection<? extends E> c) {
        super(
                new HashEntries.TransientValue<E, Object>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        equalityComparator,
    ...
    public HashSet(int initCapacity, Collection<? extends E> c) {
        super(
                new HashEntries.TransientValue<E, Object>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        null,
