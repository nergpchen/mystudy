...
import org.babyfish.reference.ReferenceComparator;
...
implements LazinessManageable {
    ...
    public boolean contains(Object o, ElementMatcher<? super E> matcher) {
        ...
        if (ref != null) {
            ...
            return matcher == null || matcher.match((E)o, originalElement);
        }
        this.load();
    ...
    Ref<E> visionallyAddImpl(E element) {
        ...
        if (rootData.isLoading()) {
            throw new IllegalStateException(LAZY_COMMON_RESOURCE.get().visionOperationWhenDataIsBeingLoaded());
        }
    ...
    protected static abstract class RootData<E> extends AbstractWrapperXSet.RootData<E> {
        ...
        public final void load() {
            if (!this.isLoaded()) {
                if (this.isLoading()) {
                    throw new IllegalStateException(LAZY_COMMON_RESOURCE.get().loadingOperationWhenDataIsBeingLoaded());
                }
        ...
        public final Ref<E> visionallyRead(E like, QueuedOperationType nullOrQueuedOperationType) {
            ...
            if (delayMap != null) {
                ...
                if (operator != null) {
                    ...
                    Entry<E, ?> real = delayMap.real(like);
                    if (real != null) {
