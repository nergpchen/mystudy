...
import org.babyfish.collection.conflict.spi.TemporaryListConflictVoterManager;
...
public abstract class AbstractWrapperXCollection<E> extends StatefulObject implements DisablityManageable, XCollection<E> {
    ...
    static final LazyResource<CommonResource> LAZY_COMMON_RESOURCE = LazyResource.of(CommonResource.class);
    ...
    protected AbstractWrapperXCollection(XCollection<E> base) {
        ...
        if (rootData == null) {
            throw new IllegalProgramException(LAZY_COMMON_RESOURCE.get().createRootDataMustReturnNonNull(this.getClass()));
        }
    ...
    protected AbstractWrapperXCollection(
        ...
        if (base != null) {
            ...
            if (!(base instanceof View)) {
                throw new IllegalProgramException(LAZY_COMMON_RESOURCE.get().createBaseViewMustReturnView(this.getClass(), View.class));
            }
            this.setBase(base);
        }
    }
    ...
    protected AbstractElementEventDispatcher<E> createEventDispatcher() {
        throw new IllegalProgramException(
                LAZY_COMMON_RESOURCE.get().mustOverrideCreateEventDispatcher(
    ...
    public boolean isNonFairLockSupported() {
        return this.rootData instanceof ConstructOnlyRootData && this.rootData.base.isNonFairLockSupported();
    }
    ...
    protected final void requiredEnabled() {
        if (this.rootData.disabled) {
            throw new IllegalStateException(
                    LAZY_COMMON_RESOURCE.get().currentCollectionIsDisabled(this.getClass())
            );
        }
    }
    ...
    private void setBase(XCollection<E> base) {
        ...
        if (oldBase != base) {
            ...
            BinaryAction<Object, Object> oldWrapperAwareAction = null;
            if (oldBase != null) {
                oldWrapperAwareAction = 
                        WrapperAwareActionFactory
                        .getWrapperAwareAction(oldBase.getClass());
            }
            BinaryAction<Object, Object> wrapperAwareAction = null;
            if (base != null) {
                wrapperAwareAction = 
                        WrapperAwareActionFactory
                        .getWrapperAwareAction(base.getClass());
            }
            ...
            if (this instanceof ModificationAware) {
                ...
                Arguments.mustBeInstanceOfValueWhen(
                        LAZY_COMMON_RESOURCE.get().whenThisIsModificationAware(ModificationAware.class), 
                        "base", 
                        base, 
                        MACollection.class);
            }
            ...
            if (oldWrapperAwareAction != null) {
                oldWrapperAwareAction.run(oldBase, null);
            }
            this.base = base;
            this.expectRootModCount = this.rootData.modCount;
            if (wrapperAwareAction != null) {
                wrapperAwareAction.run(base, this);
            }
            if (dispatcher != null) {
    ...
    private AbstractElementEventDispatcher<E> eventDispatcher() {
        ...
        if (dispatcher == null) {
            throw new IllegalProgramException(
                    LAZY_COMMON_RESOURCE.get().createEventDispatcherMustReturnNonNull(this.getClass())
            );
        }
        if (dispatcher.getOwner() != this) {
            throw new IllegalProgramException(
                    LAZY_COMMON_RESOURCE.get().ownerOfReturnedValueOfCreateEventDispatcherMustBeThis(this.getClass()));
        }
        return dispatcher;
    }
    ...
    protected static abstract class AbstractIteratorImpl<E> implements XIterator<E> {
        ...
        @Override
        public boolean isNonFairLockSupported() {
            return this.base.isNonFairLockSupported();
        }
        ...
        protected void checkForComodification() {
            if (this.expectedRootModCount != this.parent.rootData.modCount) {
                throw new ConcurrentModificationException(LAZY_COMMON_RESOURCE.get().concurrentModification());
            }
        }
        ...
        private AbstractElementEventDispatcher<E> eventDispatcher() {
            AbstractElementEventDispatcher<E> dispatcher = this.createEventDispatcher();
            if (dispatcher == null) {
                throw new IllegalProgramException(LAZY_COMMON_RESOURCE.get().createEventDispatcherMustReturnNonNull(this.getClass()));
            }
            if (dispatcher.getOwner() != this) {
                throw new IllegalProgramException(LAZY_COMMON_RESOURCE.get().ownerOfReturnedValueOfCreateEventDispatcherMustBeThis(this.getClass()));
            }
            return dispatcher;
        }
    }
    ...
    protected static class RootData<E> implements Serializable {
        ...
        private TemporaryListConflictVoterManager<E> temporaryVoterManager;
        ...
        public final <T extends XCollection<E>> T getBase(boolean canReturnNull) {
            ...
            if (base == null) {
                if (this instanceof ConstructOnlyRootData) {
                    throw new IllegalProgramException(
                            LAZY_COMMON_RESOURCE.get().mustSetTheBaseInContstructorWhenTheRootDataImplementsRootData(
                ...
                if (base == null) {
                    throw new IllegalProgramException(LAZY_COMMON_RESOURCE.get().createDefaultBaseMustReturnNonNull(this.getClass()));
                }
                this.setBase(base);
            }
            return (T)base;
        ...
        protected void setBase(XCollection<E> base) {
            if (this.deserializing) {
                throw new IllegalStateException(LAZY_COMMON_RESOURCE.get().canNotSetBaseDuringSerializing());
            }
            XCollection<E> oldBase = this.base;
            if (oldBase != null && this instanceof SetOnceOnlyRootData) {
                throw new IllegalStateException(
                        LAZY_COMMON_RESOURCE.get().canNotSetBaseTwiceWhenTheRootDataIsSetOnceOnlyRootData(
                                SetOnceOnlyRootData.class));
            }
            if (base == null && this instanceof ConstructOnlyRootData) {
                throw new IllegalArgumentException(
                        LAZY_COMMON_RESOURCE.get().canNotSetNullBaseWhenTheRootDataIsContructorOnlyRootData(
                                ConstructOnlyRootData.class));
            }
            if (oldBase != base) {
                Arguments.mustNotBeInstanceOfValue("base", "base", View.class);
                if (base != null) {
                    ...
                    if (defaultUnifiedComparator != null) {
                        Arguments.mustBeEqualToOtherWhen(
                                LAZY_COMMON_RESOURCE.get().whenDefaultUnifiedComparatorIsNotNull(), 
                ...
                TemporaryListConflictVoterManager<E> temporaryVoterManager = this.temporaryVoterManager;
                ...
                if (oldBase != null) {
                    ...
                    if (temporaryVoterManager != null && oldBase instanceof XList<?>) {
                        temporaryVoterManager.removeFrom((XList<E>)oldBase);
                    }
                }
                this.base = base;
                this.modCount++;
                if (base != null) {
                    if (temporaryVoterManager != null) {
                        if (base instanceof XList<?>) {
                            temporaryVoterManager.addTo((XList<E>)base);
                        }
                        if (this instanceof SetOnceOnlyRootData) {
                            this.temporaryVoterManager = null;
                        }
                    }
                    if (validator != null) {
        ...
        public final void addConflictVoter(ListConflictVoter<E> voter) {
            XCollection<E> base = this.base;
            if (!(base instanceof XList<?>) || !(this instanceof SetOnceOnlyRootData)) {
                this.temporaryVoterManager = TemporaryListConflictVoterManager.combine(this.temporaryVoterManager, voter);
            }
            if (base instanceof XList<?>) {
        ...
        public final void removeConflictVoter(ListConflictVoter<E> voter) {
            XCollection<E> base = this.base;
            if (!(base instanceof XList<?>) || !(this instanceof SetOnceOnlyRootData)) {
                this.temporaryVoterManager = TemporaryListConflictVoterManager.remove(this.temporaryVoterManager, voter);
            }
            if (base instanceof XList<?>) {
        ...
        protected final <T extends AbstractWrapperXCollection<E>> T getRootWrapper() {
            ...
            if (rootWrapper == null) {
                throw new IllegalStateException(
                        LAZY_COMMON_RESOURCE.get().invokeGetRootOwnerTooEarlySoThatTheRootOwnerIsNull()
                );
            }
