...
public abstract class GraphTraveler<N> {
    ...
    private static final Combiner<GraphTravelAction<?>> ACTION_COMBINER =
        (Combiner)Combiners.of(GraphTravelAction.class);
    ...
    private static <N> GraphTravelAction<N> combineActions(
        ...
        for (GraphTravelAction<N> graphTravelAction : graphTravelActions) {
            combinedGraphTravelAction = (GraphTravelAction<N>) ACTION_COMBINER.combine(
    ...
    private abstract class Context implements GraphTravelContext<N> {
        ...
        public N getNode() {
            if (this.depth == -1) {
                throw new IllegalStateException(LAZY_RESOURCE.get().invokedMethodTooEarly(GraphTravelContext.class, "getNode"));
            }
            return this.node;
        }
        ...
        public Collection<N> getStartNodes() {
            if (this.depth == -1) {
                throw new IllegalStateException(LAZY_RESOURCE.get().invokedMethodTooEarly(GraphTravelContext.class, "getStartNode"));
            }
        ...
        public int getDepth() {
            if (this.depth == -1) {
                throw new IllegalStateException(LAZY_RESOURCE.get().invokedMethodTooEarly(GraphTravelContext.class, "getDepth"));
            }
            return this.depth;
        }
        ...
        public XList<N> getBranchNodes() {
            ...
            if (branchNodes == null) {
                if (this.depth == -1) {
                    throw new IllegalStateException(LAZY_RESOURCE.get().invokedMethodTooEarly(GraphTravelContext.class, "getBranchNodes"));
                }
        ...
        public XList<Integer> getBranchNodeIndexes() {
            ...
            if (branchNodeIndexes == null) {
                if (this.depth == -1) {
                    throw new IllegalStateException(LAZY_RESOURCE.get().invokedMethodTooEarly(GraphTravelContext.class, "getBranchNodeIndexes"));
                }
                int size = this.depth + 1;
        ...
        public void stopTravelSiblingNodes() {
            if (this.depth == -1) {
                throw new IllegalStateException(LAZY_RESOURCE.get().invokedMethodTooEarly(GraphTravelContext.class, "stopTravelSiblingNodes"));
            }
            if (!this.duringBeforeTravelNeighborNodes) {
                throw new UnsupportedOperationException(
                        LAZY_RESOURCE.get().invocationMustDuringBeforeTravelNeighborNodes(
                                this.getClass(), 
        ...
        public void stopTravelNeighborNodes() {
            if (this.depth == -1) {
                throw new IllegalStateException(LAZY_RESOURCE.get().invokedMethodTooEarly(GraphTravelContext.class, "stopTravelNeighborNodes"));
            }
            if (!this.duringBeforeTravelNeighborNodes) {
                throw new UnsupportedOperationException(
                        LAZY_RESOURCE.get().invocationMustDuringBeforeTravelNeighborNodes(
        ...
        public void stopTravel() {
            if (this.depth == -1) {
                throw new IllegalStateException(LAZY_RESOURCE.get().invokedMethodTooEarly(GraphTravelContext.class, "stopTravel"));
            }
            if (!this.duringBeforeTravelNeighborNodes) {
                throw new UnsupportedOperationException(
                        LAZY_RESOURCE.get().invocationMustDuringBeforeTravelNeighborNodes(
        ...
        public long getId() {
            ...
            if (id == 0L) {
                throw new UnsupportedOperationException(
                        LAZY_RESOURCE.get().getIdIsInvalidBecauseContextIdAllocatingIsNotSupported(
                                this.getClass(),
                                GraphTraveler.class
                        )
                );
    ...
    private interface Resource {
        ...
        String invokedMethodTooEarly(Class<?> contextType, String methodName);

        @SuppressWarnings("rawtypes")
        String invocationMustDuringBeforeTravelNeighborNodes(
                Class<?> runtimeType, 
                String methodName,
        ...
        @SuppressWarnings("rawtypes")
        String getIdIsInvalidBecauseContextIdAllocatingIsNotSupported(
                Class<?> runtimeType, 
                Class<GraphTraveler> graphTravelerType);
    }
}
