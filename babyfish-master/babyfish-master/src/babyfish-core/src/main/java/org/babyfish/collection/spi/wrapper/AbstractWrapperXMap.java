...
import org.babyfish.collection.conflict.spi.TemporaryMapConflictVoterManager;
...
public abstract class AbstractWrapperXMap<K, V> extends StatefulObject implements DisablityManageable, XMap<K, V> {
        ...
        if (base != null) {
            ...
            if (!(base instanceof View)) {
                throw new IllegalProgramException(
                        LAZY_COMMON_RESOURCE.get().createBaseViewMustReturnView(this.getClass(), View.class)
                );
            }
            this.setBase(base);
        }
    ...
    @Override
    public final void addConflictVoter(MapConflictVoter<K, V> voter) {
        this.rootData.addConflictVoter(voter);
    }

    @Override
    public final void removeConflictVoter(MapConflictVoter<K, V> voter) {
        this.rootData.removeConflictVoter(voter);
    }
    ...
    @Override
    public final Ref<K> keyOf(V value) {
        this.requiredEnabled();
    ...
    private void setBase(XMap<K, V> base) {
        ...
        if (oldBase != base) {
            ...
            BinaryAction<Object, Object> wrapperWwareAction = null;
            if (base != null) {
                wrapperWwareAction = 
                        WrapperAwareActionFactory
            ...
            if (wrapperWwareAction != null) {
                wrapperWwareAction.run(base, this);
            }
            if (dispatcher != null) {
    ...
    protected static class EntrySetImpl<K, V> implements XEntrySetView<K, V>, DisablityManageable {
        ...
        @Override
        public boolean isNonFairLockSupported() {
            return this.parentMap.isNonFairLockSupported();
        }
    ...
    protected static abstract class AbstractKeySetImpl<K, V> implements XKeySetView<K>, DisablityManageable {
        ...
        protected static abstract class AbstractIteratorImpl<K, V> implements XIterator<K> {
            ...
            @Override
            public boolean isNonFairLockSupported() {
                return this.getBase().isNonFairLockSupported();
            }
    ...
    protected static class RootData<K, V> implements Serializable {
        ...
        private TemporaryMapConflictVoterManager<K, V> voterManager;
        ...
        protected void setBase(XMap<K, V> base) {
            ...
            if (oldBase != base) {
                ...
                TemporaryMapConflictVoterManager<K, V> temporaryVoterManager = this.voterManager;
                ...
                if (oldBase != null) {
                    ...
                    if (temporaryVoterManager != null) {
                        temporaryVoterManager.removeFrom(oldBase);
                    }
                }
                this.base = base;
                this.modCount++;
                if (base != null) {
                    ...
                    if (temporaryVoterManager != null) {
                        temporaryVoterManager.addTo(base);
                        if (this instanceof SetOnceOnlyRootData) {
        ...
        public final void addConflictVoter(MapConflictVoter<K, V> voter) {
            XMap<K, V> base = this.base;
            if (base == null || !(this instanceof SetOnceOnlyRootData)) {
                this.voterManager = TemporaryMapConflictVoterManager.combine(this.voterManager, voter);
            }
            if (base != null) {
        ...
        public final void removeConflictVoter(MapConflictVoter<K, V> voter) {
            XMap<K, V> base = this.base;
            if (base == null || !(this instanceof SetOnceOnlyRootData)) {
                this.voterManager = TemporaryMapConflictVoterManager.remove(this.voterManager, voter);
            }
            if (base != null) {
