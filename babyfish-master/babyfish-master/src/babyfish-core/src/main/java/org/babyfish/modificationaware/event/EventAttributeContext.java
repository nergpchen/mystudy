...
public abstract class EventAttributeContext extends AttributeContext {
    ...
    private static class Global extends EventAttributeContext implements GlobalAttributeContext {
        ...
        public void setThrowable(Throwable throwable) {
            if (throwable != null) {
                if (this.successed) {
                    throw new IllegalStateException(LAZY_RESOURCE.get().currentGlobalIsAlreadySuccessed(Global.class));
                }
        ...
        public void success() {
            if (this.throwable != null) {
                throw new IllegalStateException(LAZY_RESOURCE.get().currentGlobalIsAlreadyFailed(Global.class));
            }
            this.successed = true;
        }
        ...
        private interface Resource {
            ...
            String currentGlobalIsAlreadySuccessed(Class<Global> globalType);
            
            String currentGlobalIsAlreadyFailed(Class<Global> globalType);
        }
    }
}
