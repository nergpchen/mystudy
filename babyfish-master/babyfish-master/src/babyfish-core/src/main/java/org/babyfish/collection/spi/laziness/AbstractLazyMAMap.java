...
public abstract class AbstractLazyMAMap<K, V> extends AbstractLazyXMap<K, V> implements MAMap<K, V> {
    ...
    implements MAKeySetView<K, V> {
        ...
        protected void bubbleModifying(final KeySetElementEvent<K, V> e) {
            ...
            if (parent != null) {
                KeySetElementEvent<K, V> bubbleEvent = KeySetElementEvent.bubbleEvent(
                        parent, 
                        new Cause(this.viewInfo(), e), 
                        null, null);
                parent.executeModifying(bubbleEvent);
    ...
    protected static class RealEntryImpl<K, V> extends AbstractEntryImpl<K, V> {
        ...
        protected RealEntryImpl(AbstractLazyMAMap<K, V> parentMap, K key) throws NoEntryException {
