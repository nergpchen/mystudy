...
public abstract class UnifiedComparator<T> implements Serializable {
    ...
    public static <T> UnifiedComparator<? super T> of(Object o) {
        ...
        throw new IllegalArgumentException(
                LAZY_RESOURCE.get().mustBeNullOrInstanceOfAnyOf(
                        "o", 
                        Collection.class,
    ...
    public static Object unwrap(Object o) {
        ...
        throw new IllegalArgumentException(
                LAZY_RESOURCE.get().mustBeNullOrInstanceOfAnyOf("o", Comparator.class, EqualityComparator.class)
        );
    }
        ...
        public EqualityComparator<T> equalityComparator(boolean force) {
            if (force) {
                throw new IllegalStateException(
                        LAZY_RESOURCE.get().currentUnifiedComparatorIsNotAWrapperOf(
    ...
    private interface Resource {
        ...
        String mustBeNullOrInstanceOfAnyOf(String parameterName, Class<?> ... types);
        
        @SuppressWarnings("rawtypes")
        String currentUnifiedComparatorIsNotAWrapperOf(Class<UnifiedComparator> unifiedComparatorType, Class<?> baseType);
    }
