...
import org.babyfish.collection.spi.AbstractXOrderedSet;
import org.babyfish.collection.spi.base.LinkedHashEntries;

/**
 * @author Tao Chen
 */
public class LinkedHashSet<E> extends AbstractXOrderedSet<E> implements Serializable {
    
    private static final long serialVersionUID = -1101842133982685246L;
    ...
    public LinkedHashSet(ReplacementRule replacementRule) {
        super(
                new LinkedHashEntries.TransientValue<E, Object>(
                        replacementRule,
                        null,
    ...
    public LinkedHashSet(EqualityComparator<? super E> equalityComparator) {
        super(
                new LinkedHashEntries.TransientValue<E, Object>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        equalityComparator,
    ...
    public LinkedHashSet(ReplacementRule replacementRule, EqualityComparator<? super E> equalityComparator) {
        super(
                new LinkedHashEntries.TransientValue<E, Object>(
                        replacementRule,
                        equalityComparator,
    ...
    public LinkedHashSet(ReplacementRule replacementRule, int initCapacity) {
        super(
                new LinkedHashEntries.TransientValue<E, Object>(
                        replacementRule,
                        null,
    ...
    public LinkedHashSet(EqualityComparator<? super E> equalityComparator, int initCapacity) {
        super(
                new LinkedHashEntries.TransientValue<E, Object>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        equalityComparator,
    ...
    public LinkedHashSet(boolean headAppend) {
        super(
                new LinkedHashEntries.TransientValue<E, Object>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        null,
    ...
    public LinkedHashSet(boolean headAppend, OrderAdjustMode accessMode) {
        super(
                new LinkedHashEntries.TransientValue<E, Object>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        null,
    ...
    public LinkedHashSet(ReplacementRule replacementRule, boolean headAppend) {
        super(
                new LinkedHashEntries.TransientValue<E, Object>(
                        replacementRule,
                        null,
    ...
    public LinkedHashSet(EqualityComparator<? super E> equalityComparator, boolean headAppend) {
        super(
                new LinkedHashEntries.TransientValue<E, Object>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        equalityComparator,
    ...
    public LinkedHashSet(int initCapacity, boolean headAppend) {
        super(
                new LinkedHashEntries.TransientValue<E, Object>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        null,
    ...
    public LinkedHashSet(ReplacementRule replacementRule, Collection<? extends E> c) {
        super(
                new LinkedHashEntries.TransientValue<E, Object>(
                        replacementRule,
                        null,
    ...
    public LinkedHashSet(EqualityComparator<? super E> equalityComparator, Collection<? extends E> c) {
        super(
                new LinkedHashEntries.TransientValue<E, Object>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        equalityComparator,
    ...
    public LinkedHashSet(int initCapacity, Collection<? extends E> c) {
        super(
                new LinkedHashEntries.TransientValue<E, Object>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        null,
    ...
    public LinkedHashSet(boolean headAppend, Collection<? extends E> c) {
        super(
                new LinkedHashEntries.TransientValue<E, Object>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        null,
