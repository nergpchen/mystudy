...
implements LazinessManageable {
    ...
    public boolean contains(Object o, ElementMatcher<? super E> matcher) {
        this.requiredEnabled();
        this.load();
        return this.<XList<E>>getBase().contains(o, matcher);
    }
    ...
    public boolean containsAll(Collection<?> c, ElementMatcher<? super E> matcher) {
        this.requiredEnabled();
        this.load();
        return this.<XList<E>>getBase().containsAll(c, matcher);
    }
    ...
    public int indexOf(Object o, ElementMatcher<? super E> matcher) {
        this.requiredEnabled();
        this.load();
        return this.<XList<E>>getBase().indexOf(o, matcher);
    }
    ...
    public int lastIndexOf(Object o, ElementMatcher<? super E> matcher) {
        this.requiredEnabled();
        this.load();
        return this.<XList<E>>getBase().lastIndexOf(o, matcher);
    }
