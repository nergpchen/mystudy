...
import org.babyfish.lang.reflect.PropertyInfo.InvalidPropertyException;
...
public final class ClassInfo<T> implements AnnotatedElement {
    ...
    public static Class<?> forInternalName(String internalNameOrDescriptor) {
        ...
        if (internalNameOrDescriptor.charAt(0) == 'L') {
            if(internalNameOrDescriptor.charAt(internalNameOrDescriptor.length() - 1) != ';') {
                throw new IllegalArgumentException(LAZY_RESOURCE.get().descriptorMustEndWithSemi(internalNameOrDescriptor));
            }
    ...
    public FieldInfo getDeclaredField(String name) {
        ...
        throw new NoSuchFieldInfoException(LAZY_RESOURCE.get().noSuchDeclaredFieldInfo(this, name));
    }
    ...
    public FieldInfo getField(String name) {
        ...
        throw new NoSuchFieldInfoException(LAZY_RESOURCE.get().noSuchFieldInfo(this, name));
    }
        ...
        if (methodInfo == null) {
            if (returnType == null) {
                throw new NoSuchMethodInfoException(
                        LAZY_RESOURCE.get().noSuchDeclaredErasedMethodInfo(
                                this, 
                                name, 
                ...
                throw new NoSuchMethodInfoException(
                        LAZY_RESOURCE.get().noSuchDeclaredErasedMethodInfoWithReturnType(
                                this, 
                                returnType, 
                                name, 
                                erasedParameterTypes
                        ...
                        if (cmp == null) {
                            if (returnType == null) {
                                throw new TooManyMethodInfoException(
                                        LAZY_RESOURCE.get().tooManyDeclaredResolvedMethodInfo(this, name, resolvedParameterTypes)
                                );
                            } else {
                                throw new TooManyMethodInfoException(
                                        LAZY_RESOURCE.get().tooManyDeclaredResolvedMethodInfoWithReturnType(
                                                this, 
                                                returnType, 
                                                name, 
    ...
    public MethodInfo getDeclaredResolvedMethod(
        ...
        if (methodInfo == null) {
            if (returnType == null) {
                throw new NoSuchMethodInfoException(
                        LAZY_RESOURCE.get().noSuchDeclaredResolvedMethodInfo(this, name, resolvedParameterTypes)
                );
            } else {
                throw new NoSuchMethodInfoException(
                        LAZY_RESOURCE.get().noSuchDeclaredResolvedMethodInfoWithReturnType(this, returnType, name, resolvedParameterTypes)
                );
            }
        }
        return methodInfo;
    ...
    public MethodInfo getErasedMethod(
        ...
        if (methodInfo == null) {
            if (returnType == null) {
                throw new NoSuchMethodInfoException(
                        LAZY_RESOURCE.get().noSuchErasedMethodInfo(this, name, erasedParameterTypes)
                );
            } else {
                throw new NoSuchMethodInfoException(
                        LAZY_RESOURCE.get().noSuchErasedMethodInfoWithReturnType(this, returnType, name, erasedParameterTypes)
                );
            }
        }
        return methodInfo;
                    ...
                    public void preTravelNeighborNodes(GraphTravelContext<ClassInfo<?>> ctx) {
                        ...
                        if (methodInfo != null) {
                            if (methodInfoRef.get() != null) {
                                if (returnType == null) {
                                    throw new TooManyMethodInfoException(
                                            LAZY_RESOURCE.get().tooManyResolvedMethodInfo(
                                                    ClassInfo.this, 
                                                    name, 
                                                    resolvedParameterTypes
                                            )
                                    ...
                                    throw new TooManyMethodInfoException(
                                            LAZY_RESOURCE.get().tooManyResolvedMethodInfoWithReturnType(
                                                    ClassInfo.this, 
                                                    returnType,
                                                    name, 
                                                    resolvedParameterTypes
    ...
    public MethodInfo getResolvedMethod(
        ...
        if (methodInfo == null) {
            if (returnType == null) {
                throw new NoSuchMethodInfoException(
                        LAZY_RESOURCE.get().noSuchResolvedMethodInfo(this, name, resolvedParameterTypes)
                );
            } else {
                throw new NoSuchMethodInfoException(
                        LAZY_RESOURCE.get().noSuchResolvedMethodInfoWithReturnType(this, returnType, name, resolvedParameterTypes)
                );
            }
        }
        return methodInfo;
    ...
    public ConstructorInfo<T> getDeclaredErasedConstructor(
        ...
        if (constructorInfo == null) {
            throw new NoSuchConstructorInfoException(
                    LAZY_RESOURCE.get().noSuchDeclaredErasedConstructorInfo(this, erasedParameterTypes)
            );
        }
                ...
                if (matchedConstructor == null) {
                    ...
                    if (cmp == null) {
                        throw new TooManyConstructorInfoException(
                                LAZY_RESOURCE.get().tooManyDeclaredResolvedConstructorInfo(this, resolvedParameterTypes)
                        );
                    }
                    if (cmp < 0) {
                        matchedConstructor = constructor;
    ...
    public ConstructorInfo<T> getDeclaredResolvedConstructor(
        ...
        if (constructorInfo == null) {
            throw new NoSuchConstructorInfoException(
                    LAZY_RESOURCE.get().noSuchDeclaredResolvedConstructorInfo(this, resolvedParameterTypes)
            );
        }
        return constructorInfo;
    }
    ...
    public PropertyInfo getDeclaredErasedProperty(
        ...
        if (propertyInfo == null) {
            throw new NoSuchPropertyInfoException(
                    LAZY_RESOURCE.get().noSuchDeclaredErasedPropertyInfo(this, name, erasedParameterTypes)
            );
        }
        return propertyInfo;
    }
                    ...
                    if (matchedProperty == null) {
                        ...
                        if (cmp == null) {
                            throw new TooManyPropertyInfoException(
                                    LAZY_RESOURCE.get().tooManyDeclaredResolvedPropertyInfo(this, name, resolvedParameterTypes)
                            );
                        }
                        if (cmp < 0) {
                            matchedProperty = property;
    ...
    public PropertyInfo getDeclaredResolvedProperty(
        ...
        if (propertyInfo == null) {
            throw new NoSuchPropertyInfoException(
                    LAZY_RESOURCE.get().noSuchDeclaredResolvedPropertyInfo(this, name, resolvedParameterTypes)
            );
        }
        return propertyInfo;
    }
    ...
    public PropertyInfo getErasedProperty(
        ...
        if (propertyInfo == null) {
            throw new NoSuchPropertyInfoException(
                    LAZY_RESOURCE.get().noSuchErasedPropertyInfo(this, name, erasedParameterTypes)
            );
        }
        return propertyInfo;
    }
                    ...
                    public void preTravelNeighborNodes(GraphTravelContext<ClassInfo<?>> ctx) {
                        ...
                        if (propertyInfo != null) {
                            if (propertyInfoRef.get() != null) {
                                throw new TooManyPropertyInfoException(
                                        LAZY_RESOURCE.get().tooManyResolvedPropertyInfo(ClassInfo.this, name, resolvedParameterTypes)
                                );
                            }
                            propertyInfoRef.set(propertyInfo);
                            ctx.stopTravelNeighborNodes();
    ...
    public PropertyInfo getResolvedProperty(
        ...
        PropertyInfo propertyInfo = this.tryGetResolvedProperty(
                ...
                resolvedParameterTypes);
        if (propertyInfo == null) {
            throw new NoSuchPropertyInfoException(LAZY_RESOURCE.get().noSuchResolvedPropertyInfo(this, name, resolvedParameterTypes));
        }
        return propertyInfo;
    }
    ...
    public ClassInfo<?> getDeclaredNestedClass(String simpleName, Type ... actualTypeArguments) {
        ...
        throw new NoSuchClassInfoException(LAZY_RESOURCE.get().noSuchDeclaredNestedClassInfo(this, simpleName));
    }
    ...
    public ClassInfo<?> getNestedClass(String simpleName, Type ... actualTypeArguments) {
        ...
        throw new NoSuchClassInfoException(LAZY_RESOURCE.get().noSuchNestedClassInfo(this, simpleName));
    }
    ...
    private interface Resource {
        ...
        String descriptorMustEndWithSemi(String internalName);

        String noSuchDeclaredFieldInfo(ClassInfo<?> classInfo, String name);
        
        String noSuchFieldInfo(ClassInfo<?> classInfo, String name);

        String noSuchDeclaredErasedMethodInfo(ClassInfo<?> classInfo, String name, List<Class<?>> parameterTypes);

        String noSuchDeclaredErasedMethodInfoWithReturnType(ClassInfo<?> classInfo, Class<?> returnType, String name, List<Class<?>> parameterTypes);

        String noSuchErasedMethodInfo(ClassInfo<?> classInfo, String name, List<Class<?>> parameterTypes);

        String noSuchErasedMethodInfoWithReturnType(ClassInfo<?> classInfo, Class<?> returnType,String name, List<Class<?>> parameterTypes);

        String noSuchDeclaredResolvedMethodInfo(ClassInfo<?> classInfo, String name, List<Class<?>> parameterTypes);

        String noSuchDeclaredResolvedMethodInfoWithReturnType(ClassInfo<?> classInfo, Class<?> returnType,String name, List<Class<?>> parameterTypes);

        String noSuchResolvedMethodInfo(ClassInfo<?> classInfo, String name, List<Class<?>> parameterTypes);
        
        String noSuchResolvedMethodInfoWithReturnType(ClassInfo<?> classInfo, Class<?> returnType, String name, List<Class<?>> parameterTypes);
        
        String tooManyDeclaredResolvedMethodInfo(ClassInfo<?> classInfo, String name, List<Class<?>> parameterTypes);

        String tooManyDeclaredResolvedMethodInfoWithReturnType(ClassInfo<?> classInfo, Class<?> returnType, String name, List<Class<?>> parameterTypes);

        String tooManyResolvedMethodInfo(ClassInfo<?> classInfo, String name, List<Class<?>> parameterTypes);

        String tooManyResolvedMethodInfoWithReturnType(ClassInfo<?> classInfo, Class<?> returnType, String name, List<Class<?>> parameterTypes);

        String noSuchDeclaredErasedConstructorInfo(ClassInfo<?> classInfo, List<Class<?>> parameterTypes);
                
        String noSuchDeclaredResolvedConstructorInfo(ClassInfo<?> classInfo, List<Class<?>> parameterTypes);
        
        String tooManyDeclaredResolvedConstructorInfo(ClassInfo<?> classInfo, List<Class<?>> parameterTypes);
                
        String noSuchDeclaredErasedPropertyInfo(ClassInfo<?> classInfo, String name, List<Class<?>> parameterTypes);

        String noSuchErasedPropertyInfo(ClassInfo<?> classInfo, String name, List<Class<?>> parameterTypes);

        String noSuchDeclaredResolvedPropertyInfo(ClassInfo<?> classInfo, String name, List<Class<?>> parameterTypes);

        String noSuchResolvedPropertyInfo(ClassInfo<?> classInfo, String name, List<Class<?>> parameterTypes);
        
        String tooManyDeclaredResolvedPropertyInfo(ClassInfo<?> classInfo, String name, List<Class<?>> parameterTypes);

        String tooManyResolvedPropertyInfo(ClassInfo<?> classInfo, String name, List<Class<?>> parameterTypes);
        
        String noSuchDeclaredNestedClassInfo(ClassInfo<?> classInfo, String name);
        
        String noSuchNestedClassInfo(ClassInfo<?> classInfo, String name);
    }
