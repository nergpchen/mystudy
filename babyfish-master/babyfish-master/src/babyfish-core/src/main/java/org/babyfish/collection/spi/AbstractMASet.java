...
implements MASet<E> {
    ...
    protected interface EventCreator<E> {
        ...
        ElementEvent<E> createBubbleEvent(Object source, ViewInfo view, ElementEvent<E> e);
    }
    ...
    protected static abstract class AbstractIteratorImpl<E> implements MAIterator<E> {
            ...
            if (descending) {
                if (!(baseEntries instanceof DescendingBaseEntries<?, ?>)) {
                    throw new IllegalStateException(
                            LAZY_COMMON_RESOURCE.get().illegalDescendingOnNonDescendingSet(
        ...
        protected void bubbleModifying(ElementEvent<E> e) {
            ...
            ElementEvent<E> event = 
                parentSet.eventCreator().createBubbleEvent(parentSet, this.viewInfo(), e);
        ...
        public boolean isNonFairLockSupported() {
            return this.parentSet.isNonFairLockSupported();
        }
    ...
    private static class EventCreatorImpl4Set<E> implements EventCreator<E> {
        ...
        @Override
        public ElementEvent<E> createBubbleEvent(Object source, ViewInfo viewInfo, ElementEvent<E> e) {
            return ElementEvent.bubbleEvent(source, new Cause(viewInfo, e), null);
        }
    ...
    private class EventCreatorImpl4KeySet implements EventCreator<E> {
        ...
        @Override
        public KeySetElementEvent<E, Object> createBubbleEvent(Object source, ViewInfo viewInfo, ElementEvent<E> e) {
            Arguments.mustBeInstanceOfValue("e", e, KeySetElementEvent.class);
            return KeySetElementEvent.bubbleEvent(
                    source, 
                    new Cause(viewInfo, e), 
                    null, 
                    null);
        }
