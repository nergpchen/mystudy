 ...
 * @author Tao Chen
 */
public abstract class AbstractWrapperMAOrderedMap<K, V> 
extends AbstractWrapperMAMap<K, V> 
implements MAOrderedMap<K, V> {
    
    protected AbstractWrapperMAOrderedMap(MAOrderedMap<K, V> base) {
        super(base);
    }

    protected AbstractWrapperMAOrderedMap(
            AbstractWrapperMAOrderedMap<K, V> parent,
            ViewInfo viewInfo) {
    ...
    public MAEntry<K, V> firstEntry() {
        try {
            return new FirstEntryImpl<>(this);
    ...
    implements MAOrderedKeySetView<K, V> {
        ...
        protected AbstractKeySetImpl(
                AbstractWrapperMAOrderedMap<K, V> parentMap,
    ...
    protected static class KeySetImpl<K, V> extends AbstractKeySetImpl<K, V> {
        ...
        protected KeySetImpl(AbstractWrapperMAOrderedMap<K, V> parentMap) {
    ...
    protected static class DescendingKeySetImpl<K, V> extends AbstractKeySetImpl<K, V> {
        protected DescendingKeySetImpl(AbstractWrapperMAOrderedMap<K, V> parentMap) {
    ...
    protected static class FirstEntryImpl<K, V> extends AbstractEntryImpl<K, V> {
        ...
        protected FirstEntryImpl(
                AbstractWrapperMAOrderedMap<K, V> parentMap) throws NoEntryException {
    ...
    protected static class LastEntryImpl<K, V> extends AbstractEntryImpl<K, V> {
        ...
        protected LastEntryImpl(AbstractWrapperMAOrderedMap<K, V> parentMap) throws NoEntryException {
    ...
    protected static class RootData<K, V> extends AbstractWrapperMAMap.RootData<K, V> {
        ...
        private static final long serialVersionUID = -3491731993293200924L;
