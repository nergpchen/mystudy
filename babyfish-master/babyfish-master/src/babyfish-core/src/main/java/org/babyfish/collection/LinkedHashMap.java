...
import org.babyfish.collection.spi.AbstractXOrderedMap;
 ...
 * @author Tao Chen
 */
public class LinkedHashMap<K, V> extends AbstractXOrderedMap<K, V> implements Serializable {
    
    private static final long serialVersionUID = -6804277097193462640L;
    ...
    public LinkedHashMap(ReplacementRule keyReplacementRule) {
        super(
                new LinkedHashEntries<K, V>(
                        keyReplacementRule,
                        null,
    ...
    public LinkedHashMap(EqualityComparator<? super K> keyEqualityComparator) {
        super(
                new LinkedHashEntries<K, V>(
                        ReplacementRule.NEW_REFERENCE_WIN,
    ...
    public LinkedHashMap(EqualityComparator<? super K> keyEqualityComparator, EqualityComparator<? super V> valueEqualityComparator) {
        super(
                new LinkedHashEntries<K, V>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        keyEqualityComparator,
    ...
    public LinkedHashMap(EqualityComparator<? super K> keyEqualityComparator, Comparator<? super V> valueComparator) {
        super(
                new LinkedHashEntries<K, V>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        keyEqualityComparator,
    ...
    public LinkedHashMap(EqualityComparator<? super K> keyEqualityComparator, UnifiedComparator<? super V> valueUnifiedComparator) {
        super(
                new LinkedHashEntries<K, V>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        keyEqualityComparator,
    ...
    public LinkedHashMap(ReplacementRule keyReplacementRule, EqualityComparator<? super K> keyEqualityComparator) {
        super(
                new LinkedHashEntries<K, V>(
                        keyReplacementRule,
                        keyEqualityComparator,
    ...
    public LinkedHashMap(ReplacementRule keyReplacementRule, int initCapacity) {
        super(
                new LinkedHashEntries<K, V>(
                        keyReplacementRule,
                        null,
    ...
    public LinkedHashMap(EqualityComparator<? super K> keyEqualityComparator, int initCapacity) {
        super(
                new LinkedHashEntries<K, V>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        keyEqualityComparator,
    ...
    public LinkedHashMap(boolean headAppend) {
        super(
                new LinkedHashEntries<K, V>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        null,
    ...
    public LinkedHashMap(boolean headAppend, OrderAdjustMode accessMode) {
        super(
                new LinkedHashEntries<K, V>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        null,
    ...
    public LinkedHashMap(ReplacementRule keyReplacementRule, boolean headAppend) {
        super(
                new LinkedHashEntries<K, V>(
                        keyReplacementRule,
                        null,
    ...
    public LinkedHashMap(EqualityComparator<? super K> keyEqualityComparator, boolean headAppend) {
        super(
                new LinkedHashEntries<K, V>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        keyEqualityComparator,
    ...
    public LinkedHashMap(int initCapacity, boolean headAppend) {
        super(
                new LinkedHashEntries<K, V>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        null,
    ...
    public LinkedHashMap(ReplacementRule keyReplacementRule, Map<? extends K, ? extends V> m) {
        super(
                new LinkedHashEntries<K, V>(
                        keyReplacementRule,
                        null,
    ...
    public LinkedHashMap(EqualityComparator<? super K> keyEqualityComparator, Map<? extends K, ? extends V> m) {
        super(
                new LinkedHashEntries<K, V>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        keyEqualityComparator,
    ...
    public LinkedHashMap(int initCapacity, Map<? extends K, ? extends V> m) {
        super(
                new LinkedHashEntries<K, V>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        null,
    ...
    public LinkedHashMap(boolean headAppend, Map<? extends K, ? extends V> m) {
        super(
                new LinkedHashEntries<K, V>(
                        ReplacementRule.NEW_REFERENCE_WIN,
                        null,
