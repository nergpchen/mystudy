 ...
 * @author Tao Chen
 */
public class OwnerEqualityComparatorWritingReplacement implements Serializable {
    
    private static final long serialVersionUID = 6765429962308663744L;

    protected Class<?> ownerClass;
    
    protected int[] scalarPropertyIds;

    public OwnerEqualityComparatorWritingReplacement(Class<?> ownerClass, int[] scalarPropertyIds) {
    ...
    protected final Object readResolve() throws ObjectStreamException {
        return this
                ...
                .getOwnerEqualityComparator(this.scalarPropertyIds);
    }
