...
extends 
XMap<K, V>, 
MapElementModificationAware<K, V> {
    
    @Override
    void addMapElementListener(MapElementListener<? super K, ? super V> listener);
    
    @Override
    void removeMapElementListener(MapElementListener<? super K, ? super V> listener);
