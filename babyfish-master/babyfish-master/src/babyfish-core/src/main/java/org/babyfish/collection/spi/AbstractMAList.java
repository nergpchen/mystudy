...
public abstract class AbstractMAList<E> extends AbstractXList<E> implements MAList<E> {
    ...
    protected static class ListIteratorImpl<E> implements MAListIterator<E> {
        ...
        private ListViewInfos.ListIteratorByIndex viewInfo;
        ...
        protected void bubbleModifying(ListElementEvent<E> e) {
            ...
            ListElementEvent<E> event = ListElementEvent.bubbleEvent(
                    parentList, 
                    new Cause(this.viewInfo, e), 
                    null, 
                    null);
            parentList.executeModifying(event);
        }

        protected void bubbleModified(ListElementEvent<E> e) {
            ListElementEvent<E> bubbleEvent = e.getBubbledEvent();
            this.parentList.executeModified(bubbleEvent);
        }
        ...
        public boolean isNonFairLockSupported() {
            return this.parentList.isNonFairLockSupported();
        }
            ...
            ListElementEvent<E> event = ListElementEvent.bubbleEvent(
                    ...
                    new BubbledPropertyConverter<Integer>() {
                        ...
                        public void convert(BubbledProperty<Integer> bubbledProperty) {
                            int offset = SubListImpl.this.viewInfo().getFromIndex();
                            ...
                            if (bubbledProperty.contains(PropertyVersion.ATTACH)) {
                                ...
                                if (!conflictAbsIndexes.isEmpty()) {
                                    ...
                                    offset -= conflictAbsIndexes.subSet(that.headHide - offset, true, that.headHide, false).size();
                                }
