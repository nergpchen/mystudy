...
public class MALinkedList<E> extends AbstractMAList<E> implements Serializable {
    ...
    public MALinkedList(ReaderOptimizationType readerOptimizationType, EqualityComparator<? super E> equalityComparator) {
        super(
                new LinkedElements<E>(
                        readerOptimizationType,
                        equalityComparator
    ...
    public MALinkedList(ReaderOptimizationType readerOptimizationType, Comparator<? super E> comparator) {
        super(
                new LinkedElements<E>(
                        readerOptimizationType,
                        comparator
    ...
    public MALinkedList(ReaderOptimizationType readerOptimizationType, UnifiedComparator<? super E> unifiedComparator) {
        super(
                new LinkedElements<E>(
                        readerOptimizationType,
                        unifiedComparator
    ...
    public MALinkedList(ReaderOptimizationType readerOptimizationType, Collection<? extends E> c) {
        super(
                new LinkedElements<E>(
                        readerOptimizationType,
                        null
    ...
    public MALinkedList(EqualityComparator<? super E> equalityComparator, Collection<? extends E> c) {
        super(
                new LinkedElements<E>(
                        ReaderOptimizationType.OPTIMIZE_READING,
                        equalityComparator
    ...
    public MALinkedList(UnifiedComparator<? super E> unifiedComparator, Collection<? extends E> c) {
        super(
                new LinkedElements<E>(
                        ReaderOptimizationType.OPTIMIZE_READING,
                        unifiedComparator
