...
public class MapKeyPath<K> extends AbstractPath<K> {
    ...
    protected Attribute<? super K, ?> onLocateAttribute(String attributeName) {
        throw new UnsupportedOperationException(LAZY_RESOURCE.get().unSupportedByMapKeyPath(MapKeyPath.class)); 
    }
    ...
    private interface Resource {
        ...
        String unSupportedByMapKeyPath(Class<MapKeyPath> mapKeyPathType);
    }
}
