 ...
 * @author Tao Chen
 */
public class CurrentTimeFunction extends AbstractFunction<Time> {
    
    private static final long serialVersionUID = -6423478986038709959L;
    
    private static final String FUNCTION_NAME = "current_time";
