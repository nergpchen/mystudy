...
public abstract class AbstractPath<X> extends AbstractExpression<X> implements Path<X> {
    ...
    protected void throwIllegalReferenceException() {
        throw new IllegalArgumentException(LAZY_RESOURCE.get().illegalReference());
    }
    
    protected void throwUnknowAttributeException(String attributeName) {
        throw new IllegalArgumentException(LAZY_RESOURCE.get().illegalAttributeName(attributeName));
    }
    ...
    private interface Resource {
        ...
        String illegalReference();

        String illegalAttributeName(String attributeName);
    }
}
