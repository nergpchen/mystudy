...
public class SearchedCaseExpression<R> extends AbstractExpression<R> implements Case<R> {
    ...
    public Class<? extends R> getJavaType() {
        if (whenClauses.isEmpty() || this.otherwiseResult == null) {
            throw new IllegalStateException(LAZY_RESOURCE.get().missWhenOrOtherwise(SearchedCaseExpression.class));
        }
    ...
    private interface Resource {
        ...
        String missWhenOrOtherwise(Class<SearchedCaseExpression> searchedCaseExpressionType);
    }
}
