 ...
 * @author Tao Chen
 */
public class PersistentMANavigableSet<E> 
extends AbstractLazyMANavigableSet<E>
implements PersistentCollection<E>, Serializable {
    ...
    public PersistentMANavigableSet(String role, SessionImplementor session, MANavigableSet<E> base) {
        super(null);
    ...
    @WrapperAware
    void setWrapper(XCollection<E> wrapper) {
    ...
    protected static class RootData<E> extends AbstractLazyMANavigableSet.RootData<E> {
        ...
        protected void onInitialize() {
            this.basePersistence = new SetBasePersistence<E>() {
                ...
                protected void setBase(MASet<E> base) {
                    RootData.this.setBase((MANavigableSet<E>)base);
                }

                @Override
                protected MANavigableSet<E> getBase() {
                ...
                protected PersistentCollection<E> onGetWrapperPersistentCollection() {
                    return RootData.this.<PersistentMANavigableSet<E>>getRootWrapper();
                }
        ...
        protected final void setDirectlyAccessible() {
            MANavigableSet<E> base = this.getBase(true);
            if (base != null) {
        ...
        protected int onGetVisionalSize() {
            ...
            CollectionEntry ce = 
                    ...
                    .getCollectionEntry(this.<PersistentMANavigableSet<E>>getRootWrapper());
        ...
        protected Ref<E> onVisionallyRead(E element, QueuedOperationType nullOrQueuedOperationType) {
            if (nullOrQueuedOperationType != null) {
                AssociatedEndpoint<?, E> endpoint = 
                        this
                        .<PersistentMANavigableSet<E>>getRootWrapper()
                        .getWrapperEndpoint();
                if (endpoint != null) {
                    ...
                    if (oppositeEndpoint.isSuspended()) {
                        LOGGER.info(
                                ...
                                this.<PersistentMANavigableSet<E>>getRootWrapper().getRole() +
