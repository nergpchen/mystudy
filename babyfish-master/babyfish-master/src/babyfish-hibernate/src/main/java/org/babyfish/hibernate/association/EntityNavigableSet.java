 ...
 * @author Tao Chen
 */
public abstract class EntityNavigableSet<O, E> extends AssociatedNavigableSet<O, E> implements PersistentCollection<E> {

    private static final long serialVersionUID = -1907830926123797635L;
