...
public interface HibernateAssociationProperty extends JPAAssociationProperty ,HibernateProperty {
    ...
    @Override
    HibernateAssociationProperty getOppositeProperty();
    
    @Override
    HibernateAssociationProperty getCovarianceProperty();
    
    @Override
    HibernateObjectModelMetadata getKeyObjectModelMetadata();
}
