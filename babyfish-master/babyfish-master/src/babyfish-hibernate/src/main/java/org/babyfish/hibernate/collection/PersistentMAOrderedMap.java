...
import org.babyfish.collection.spi.laziness.AbstractLazyMAOrderedMap;
...
implements PersistentCollection<V>, Serializable {
    ...
    private static final long serialVersionUID = 9087985451015921740L;
    
    private static final LazyResource<CommonResource> LAZY_COMMON_RESOURCE = 
            LazyResource.of(CommonResource.class);
    
    public PersistentMAOrderedMap(String role, SessionImplementor session, MAOrderedMap<K, V> base) {
        super(null);
    ...
    protected static class RootData<K, V> extends AbstractLazyMAOrderedMap.RootData<K, V> {
        
        private static final long serialVersionUID = -3972502696812607472L;
        ...
        protected void onInitialize() {
            MAOrderedMap<K, V> base = this.getBase(true);
            if (base != null) {
            ...
            this.basePersistence = new MapBasePersistence<K, V>() {
                ...
                @Override
                protected MAOrderedMap<K, V> getBase() {
                    return RootData.this.getBase();
                }
    
                @Override
                protected void initBase(MAMap<K, V> base) {
                    RootData.this.setBase((MAOrderedMap<K, V>)base);
                }
                ...
                protected PersistentCollection<V> onGetWrapperPersistentCollection() {
                    return RootData.this.<PersistentMAOrderedMap<K, V>>getRootWrapper();
                }
            };
        }
        ...
        protected UnifiedComparator<? super K> getDefaultKeyUnifiedComparator() {
            return
                    ...
                    this.getJPAAssociationProperty().getKeyUnifiedComparator();
        }
        ...
        protected int onGetVisionalSize() {
            ...
            CollectionEntry ce = 
                    ...
                    .getCollectionEntry(this.<PersistentMAOrderedMap<K, V>>getRootWrapper());
