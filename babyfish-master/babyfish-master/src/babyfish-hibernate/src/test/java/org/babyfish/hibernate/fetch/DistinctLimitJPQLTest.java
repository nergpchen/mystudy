 ...
 * @author Tao Chen
 */
public class DistinctLimitJPQLTest extends AbstractOracleTest {
    ...
    public void testByDistinctMode() {
        XTypedQuery<Department> typedQuery = 
                this.createQuery(QueryType.DISTINCT, 1, 2);
    ...
    public void testByResultMode() {
        XTypedQuery<Department> typedQuery = 
                this.createQuery(QueryType.RESULT, 2, 4);
        List<Department> departments = typedQuery.getResultList();
    ...
    private XTypedQuery<Department> createQuery(
        ...
        return 
                this.
                entityManager
                .createQuery("from Department d order by d.name", Department.class)
