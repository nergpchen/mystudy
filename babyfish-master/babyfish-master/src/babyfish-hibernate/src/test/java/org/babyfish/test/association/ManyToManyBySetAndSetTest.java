    ...
    private static final TestSite.CourseSetFactory[] COURSE_SET_FACTORIES =
        new TestSite.CourseSetFactory[] {
            ...
            new TestSite.CourseSetFactory() {
                ...
                @Override
                public MASet<TestSite.Course> createCourseSet() {
                    return (MASet<org.babyfish.test.association.ManyToManyBySetAndSetTest.TestSite.Course>) 
                            new MAOrderedSetType().wrap(null, new MALinkedHashSet<TestSite.Course>());
                }
            },
            new TestSite.CourseSetFactory() {
                @SuppressWarnings("unchecked")
                ...
                public MASet<TestSite.Course> createCourseSet() {
                    return (MASet<org.babyfish.test.association.ManyToManyBySetAndSetTest.TestSite.Course>) 
                            new MANavigableSetType().wrap(null, new MATreeSet<TestSite.Course>());
                }
            },
        };
    ...
    private static final TestSite.StudentSetFactory[] STUDENT_SET_FACTORIES =
        new TestSite.StudentSetFactory[] {
            ...
            new TestSite.StudentSetFactory() {
                ...
                @Override
                public MASet<TestSite.Student> createStudentSet() {
                    return (MASet<org.babyfish.test.association.ManyToManyBySetAndSetTest.TestSite.Student>) 
