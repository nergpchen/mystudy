...
public class Employee {
    ...
    public void setCodeInDepartment(String code) {
        this.om.getDepartmentReference().setKey(code);
    }
    ...
    public void setDepartment(String codeInDepartment, Department department) {
        this.om.getDepartmentReference().set(codeInDepartment, department);
    }
    ...
    private interface OM {
        ...
        @KeyMapping("codeInDepartment")
        KeyedReference<String, Department> getDepartmentReference();
    }
