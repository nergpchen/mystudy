...
public class Employee {
    ...
    public Department getDepartment() {
        return this.om.getModelDepartmentReference().get();
    }
    
    public void setDepartment(Department department) {
        this.om.getModelDepartmentReference().set(department);
    }
    ...
    private interface OM {
        ...
        @Association(opposite = "modelEmployees")
        @Mapping("department")
        Reference<Department> getModelDepartmentReference();
