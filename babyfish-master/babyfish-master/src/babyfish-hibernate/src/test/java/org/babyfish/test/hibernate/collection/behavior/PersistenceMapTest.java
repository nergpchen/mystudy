...
public class PersistenceMapTest {
    ...
    private static final TestSite.MapFactory[] MAP_FACTORIES =
        new TestSite.MapFactory[] {
            ...
            new TestSite.MapFactory() {
                ...
                @Override
                public XMap<String, String> createMap() {
                    return (XMap<String, String>) new MAOrderedMapType().wrap(null, new MALinkedHashMap<String, String>());
                }
            },
            new TestSite.MapFactory() {
                @SuppressWarnings("unchecked")
                @Override
                public XMap<String, String> createMap() {
                    return (XMap<String, String>) new MANavigableMapType().wrap(null, new MATreeMap<String, String>());
                }
            },
        };
    ...
    private static class TestSite {
        ...
        private Map<String, String> createMap() {
            ...
            map.addConflictVoter(
                    new MapConflictVoter<String, String>() {
                        @Override
                        public void vote(MapConflictVoterArgs<String, String> args) {
                            String newValue = args.newValue();
                            MapReader<String, String> reader = args.reader();
                            while (reader.read()) {
                                if (args.valueUnifiedComparator().equals(newValue, reader.value())) {
