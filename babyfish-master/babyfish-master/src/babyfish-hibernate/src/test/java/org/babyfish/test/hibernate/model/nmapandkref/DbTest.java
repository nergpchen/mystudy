...
public class DbTest {
    ...
    public void initData() {
        ...
        try {
            em.getTransaction().begin();
            try {
                em.createNativeQuery("update nmkr_DEPARTMENT d set d.COMPANY_ID = null").executeUpdate();
            } catch (RuntimeException | Error ex) {
                em.getTransaction().rollback();
                throw ex;
            }
    ...
    public void testChangeMapOfCompany() {
        ...
        try {
            ...
            Department sales = em.getReference(Department.class, 1L);
            Department market = em.getReference(Department.class, 2L);
            ...
            em.getTransaction().begin();
            try {
                ((NavigableMap<String, Department>)oracle.getDepartments()).descendingMap().put(sales.getName(), sales);
                ((NavigableMap<String, Department>)oracle.getDepartments()).descendingMap().put(market.getName(), market);
            } catch (RuntimeException | Error ex) {
                em.getTransaction().rollback();
                throw ex;
            }
        ...
        try {
            ...
            assertDepartments(oracle, "market", "sales");
        ...
        try {
            ...
            em.getTransaction().begin();
            try {
                ((NavigableMap<String, Department>)ibm.getDepartments()).descendingMap().put(sales.getName(), sales);
                ((NavigableMap<String, Department>)ibm.getDepartments()).descendingMap().put(market.getName(), market);
            } catch (RuntimeException | Error ex) {
                em.getTransaction().rollback();
                throw ex;
            }
        ...
        try {
            ...
            assertDepartments(ibm, "market", "sales");
    ...
    public void testChangeKeySetOfCompany() {
        ...
        em = entityManagerFactory.createEntityManager();
        try {
            em.createQuery("select c, d from Company c inner join fetch c.departments d").getResultList();
        } finally {
            em.close();
        }
        ...
        try {
            ...
            em.getTransaction().begin();
            try {
                ((NavigableMap<String, Department>)oracle.getDepartments()).descendingMap().descendingKeySet().descendingSet().remove("sales");
                ((NavigableMap<String, Department>)oracle.getDepartments()).descendingMap().descendingKeySet().descendingSet().remove("market");
            } catch (RuntimeException | Error ex) {
                em.getTransaction().rollback();
                throw ex;
            }
