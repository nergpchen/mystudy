...
public class HQLTest {
    ...
    @SuppressWarnings("unchecked")
    private void testCollectionFetchByAllMode(Action<XQuery> addQueryPathLambda, boolean departmentNameDesc, Boolean employeeNameDesc) {
        XQuery query;
    ...
    @SuppressWarnings("unchecked")
    private void testCollectionFetchByPartialMode(Action<XQuery> addQueryPathLambda, boolean departmentNameDesc, Boolean employeeNameDesc) {
        List<Department> departments;
        XQuery query;
