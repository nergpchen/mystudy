...
public class JPATest {
    ...
    public void testSerializeTabPage1() {
        testSerialization(new Func<TabControl, TabControl>() {
            @Override
            public TabControl run(TabControl x) {
                return serialzingClone(x.getPages().get(0)).getTabControl();
            }
        });
    }
    ...
    public void testSerializeTabPage2() {
        testSerialization(new Func<TabControl, TabControl>() {
            @Override
            public TabControl run(TabControl x) {
                return serialzingClone(x.getPages().get(1)).getTabControl();
            }
        });
    }
    ...
    public void testSerializeButton1InTabPage1() {
        testSerialization(new Func<TabControl, TabControl>() {
            @Override
            public TabControl run(TabControl x) {
                return ((TabPage)serialzingClone(x.getPages().get(0).getControls().get(0)).getParent()).getTabControl();
            }
        });
    }
    ...
    public void testSerializeButton2InTabPage1() {
        testSerialization(new Func<TabControl, TabControl>() {
            @Override
            public TabControl run(TabControl x) {
                return ((TabPage)serialzingClone(x.getPages().get(0).getControls().get(1)).getParent()).getTabControl();
            }
        });
    }
    ...
    public void testSerializeButton1InTabPage2() {
        testSerialization(new Func<TabControl, TabControl>() {
            @Override
            public TabControl run(TabControl x) {
                return ((TabPage)serialzingClone(x.getPages().get(1).getControls().get(0)).getParent()).getTabControl();
            }
        });
    }
    ...
    public void testSerializeButton2InTabPage2() {
        testSerialization(new Func<TabControl, TabControl>() {
            @Override
            public TabControl run(TabControl x) {
                return ((TabPage)serialzingClone(x.getPages().get(1).getControls().get(1)).getParent()).getTabControl();
            }
        });
    }
