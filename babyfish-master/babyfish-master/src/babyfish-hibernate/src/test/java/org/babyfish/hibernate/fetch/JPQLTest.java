...
public class JPQLTest {
    ...
    public void testCollectionFetchByAllModeAndQueryPath() {
        this.testCollectionFetchByAllMode(
                new Action<XTypedQuery<Department>>() {
                    @Override
                    public void run(XTypedQuery<Department> typedQuery) {
    ...
    private void testCollectionFetchByAllMode(Action<XTypedQuery<Department>> addQueryPathLambda, boolean departmentNameDesc, Boolean employeeNameDesc) {
        ...
        addQueryPathLambda.run(typedQuery);
    ...
    private void testCollectionFetchByPartialMode(Action<XTypedQuery<Department>> addQueryPathLambda, boolean departmentNameDesc, Boolean employeeNameDesc) {
        List<Department> departments;
        XTypedQuery<Department> typedQuery;
