...
public class ProxyTest {
    ...
    private static final HibernateObjectModelMetadata COMPANY_OM_METADATA = 
            HibernateMetadatas.of(Company.class);
    ...
    private static boolean isFrozenProxy(Object proxy) {
        if (proxy instanceof HibernateProxy) {
            ...
            FrozenLazyInitializer frozenLazyInitializer = 
                    FrozenLazyInitializerImpl.getFrozenLazyInitializer(hibernateProxy);
            try {
