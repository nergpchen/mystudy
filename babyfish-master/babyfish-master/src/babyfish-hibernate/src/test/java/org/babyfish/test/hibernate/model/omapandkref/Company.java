 ...
 * for more details.
 */
package org.babyfish.test.hibernate.model.omapandkref;
 ...
 */
@Entity
@Table(name = "omkr_COMPANY")
@SequenceGenerator(
        name = "companySequence", 
        sequenceName = "omkr_COMPANY_ID_SEQ",
        initialValue = 1,
        allocationSize = 1)
public class Company {
    ...
    private interface OM {
        ...
        @Inverse
        @Mapping("departments")
        XOrderedMap<String, Department> getModelDepartments();
    }
