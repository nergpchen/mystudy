...
public class OneToManyBySetTest {
    ...
    private static final TestSite.EmployeeSetFactory[] EMPLOYEE_SET_FACTORIES =
        new TestSite.EmployeeSetFactory[] {
            ...
            new TestSite.EmployeeSetFactory() {
                ...
                @Override
                public MASet<TestSite.Employee> createEmployeeSet() {
                    return (MASet<TestSite.Employee>) 
            ...
            new TestSite.EmployeeSetFactory() {
                ...
                public MASet<TestSite.Employee> createEmployeeSet() {
                    return (MASet<TestSite.Employee>) 
                            new MANavigableSetType().wrap(null, new MATreeSet<TestSite.Employee>());
                }
            },
        };
