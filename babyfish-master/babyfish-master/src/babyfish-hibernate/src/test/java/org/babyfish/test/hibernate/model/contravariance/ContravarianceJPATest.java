...
public class ContravarianceJPATest {
    ...
    public void testSerializeTabControl() {
        testSerialization(new Func<TabControl, TabControl>() {
            @Override
            public TabControl run(TabControl x) {
                return serialzingClone(x);
            }
        });
    }
    ...
    public void testSerializeTabPage1() {
        testSerialization(new Func<TabControl, TabControl>() {
            @Override
            public TabControl run(TabControl x) {
                return serialzingClone(x.getTabPages().get(0)).getTabControl();
            }
        });
    }
    ...
    public void testSerializeTabPage2() {
        testSerialization(new Func<TabControl, TabControl>() {
            @Override
            public TabControl run(TabControl x) {
                return serialzingClone(x.getTabPages().get(1)).getTabControl();
            }
        });
    }
    ...
    public void testSerializeButton1InTabPage1() {
        testSerialization(new Func<TabControl, TabControl>() {
            @Override
            public TabControl run(TabControl x) {
                return ((TabPage)serialzingClone(x.getTabPages().get(0).getComponents().get(0)).getParent()).getTabControl();
            }
        });
    }
    ...
    public void testSerializeButton2InTabPage1() {
        testSerialization(new Func<TabControl, TabControl>() {
            @Override
            public TabControl run(TabControl x) {
                return ((TabPage)serialzingClone(x.getTabPages().get(0).getComponents().get(1)).getParent()).getTabControl();
            }
        });
    }
    ...
    public void testSerializeButton1InTabPage2() {
        testSerialization(new Func<TabControl, TabControl>() {
            @Override
            public TabControl run(TabControl x) {
                return ((TabPage)serialzingClone(x.getTabPages().get(1).getComponents().get(0)).getParent()).getTabControl();
            }
        });
    }
    ...
    public void testSerializeButton2InTabPage2() {
        testSerialization(new Func<TabControl, TabControl>() {
            @Override
            public TabControl run(TabControl x) {
                return ((TabPage)serialzingClone(x.getTabPages().get(1).getComponents().get(1)).getParent()).getTabControl();
            }
        });
    }
    
    private void testSerialization(Func<TabControl, TabControl> serializingCloneAction) {
        ...
        TabControl deserializedTabControl = serializingCloneAction.run(tabControl);
