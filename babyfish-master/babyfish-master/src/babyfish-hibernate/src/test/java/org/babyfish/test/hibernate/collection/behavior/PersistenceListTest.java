...
public class PersistenceListTest {
        ...
        new TestSite.ListFactory[] {
            new TestSite.ListFactory() {
                ...
                public XList<String> createList() {
                    return new org.babyfish.collection.ArrayList<String>();
                }
            },
            new TestSite.ListFactory() {
                @Override
                public XList<String> createList() {
                    return new MAArrayList<String>();
                }
            },
            new TestSite.ListFactory() {
                @Override
                public XList<String> createList() {
                    return new org.babyfish.collection.LinkedList<String>();
                }
            },
            new TestSite.ListFactory() {
                @Override
                public XList<String> createList() {
                    return new MALinkedList<String>();
                }
            },
            new TestSite.ListFactory() {
                ...
                @Override
                public XList<String> createList() {
                    return (XList<String>) new MAListType().wrap(null, new MAArrayList<String>());
                }
            },
            new TestSite.ListFactory() {
                @SuppressWarnings("unchecked")
                @Override
                public XList<String> createList() {
                    return (XList<String>) new MAListType().wrap(null, new MALinkedList<String>());
                }
            },
        };
    ...
    private static class TestSite {
        ...
        private List<String> createList() {
            ...
            list.addConflictVoter(
                    new ListConflictVoter<String>() {
                        @Override
                        public void vote(ListConflictVoterArgs<String> args) {
                            UnifiedComparator<? super String> unifiedComparator = args.unifiedComparator();
                            String newElement = args.newElement();
                            ListReader<String> reader = args.reader();
                            while (reader.read()) {
                                if (unifiedComparator.equals(newElement, reader.element())) {
