 ...
 * for more details.
 */
package org.babyfish.test.hibernate.model.delay;
...
import org.babyfish.test.hibernate.model.bagandref.Department;
import org.babyfish.test.hibernate.model.bagandref.Employee;
 ...
 * @author Tao Chen
 */
public class BagAndReferenceTest extends AbstractHibernateTest {
    ...
    private void init(final boolean hasRelationship) {
        Action<Session> handler = new Action<Session>() {
            ...
            public void run(Session session) {
                ...
                Query query =
                    session
                    .createSQLQuery("INSERT INTO br_EMPLOYEE(EMPLOYEE_ID, NAME, DEPARTMENT_ID) VALUES(?, ?, ?)")
                    .setLong(0, 1L)
    ...
    public void testAddLoadedEmployeeWhenHasNotRelationship() {
        ...
        Action<Session> handler = new Action<Session>() {
            ...
            public void run(Session session) {
                ...
                ((MACollection<Employee>)department.getEmployees()).addElementListener(
