...
if [ "$database" = "o" ]; then
    java -classpath ./db-installer/project/target/war3shop-db-installer-1.0.0.Alpha.jar:./db-installer/project/target/lib/ojdbc6-11.2.0.1.0.jar -Doracle org.babyfishdemo.war3shop.db.installer.shell.Shell
else
    java -classpath ./db-installer/project/target/war3shop-db-installer-1.0.0.Alpha.jar:./db-installer/project/target/lib/hsqldb-j5-2.2.4.jar org.babyfishdemo.war3shop.db.installer.shell.Shell
fi
